...
nnoremap <silent> <Plug>(coc-explorer-key-n-*) :call coc#rpc#request('doKeymap', ['explorer-key-n-*'])
nnoremap <SNR>257_: :=v:count ? v:count : ''
...
set runtimepath+=~/.SpaceVim/bundle/vimfiler.vim
...
set tabstop=2
set tags=./tags,./TAGS,tags,TAGS,~/.cache/SpaceVim/tags/_home_lalitmee_data_Github_dotfiles_editors_spacevim_/tags
...
silent only
silent tabonly
cd ~/data/Github/dotfiles/editors/spacevim
...
nnoremap <buffer> <nowait> <silent> 0 :call startify#open_buffers(22)
nnoremap <buffer> <nowait> <silent> 11 :call startify#open_buffers(36)
nnoremap <buffer> <nowait> <silent> 10 :call startify#open_buffers(35)
nnoremap <buffer> <nowait> <silent> 1 :call startify#open_buffers(23)
nnoremap <buffer> <nowait> <silent> 2 :call startify#open_buffers(24)
nnoremap <buffer> <nowait> <silent> 3 :call startify#open_buffers(25)
nnoremap <buffer> <nowait> <silent> 4 :call startify#open_buffers(26)
nnoremap <buffer> <nowait> <silent> 5 :call startify#open_buffers(27)
nnoremap <buffer> <nowait> <silent> 6 :call startify#open_buffers(31)
nnoremap <buffer> <nowait> <silent> 7 :call startify#open_buffers(32)
nnoremap <buffer> <nowait> <silent> 8 :call startify#open_buffers(33)
nnoremap <buffer> <nowait> <silent> 9 :call startify#open_buffers(34)
...
nnoremap <buffer> <nowait> <silent> e :call startify#open_buffers(18)
nnoremap <buffer> <nowait> <silent> i :enew | startinsert
nnoremap <buffer> <expr> n ' j'[v:searchforward].'n'
nnoremap <buffer> <nowait> <silent> q :call startify#open_buffers(38)
...
tabnext 1
badd +0 ~/data/Github/dotfiles/editors/nvim/lua/config/telescope/init.lua:\ \ \ \ \ \ ignore_patterns\ =\ \{\ \'\*.git/\*\',\ \'\*/node_modules/\*\'\ },
