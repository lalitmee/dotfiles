...
let g:which_key_map.f = {
      ...
      \ 'H' : [':FzfPreviewBufferLines'                         , 'loaded-buffers-lines'],
      ...
      \ 'M' : [':FzfPreviewBufferLines'                         , 'loaded-buffers-lines'],
      ...
      \ 'W' : [':FzfPreviewMruFiles'                            , 'dir-mrw-files'],
...
let g:which_key_map.o = {
      ...
      \ 'c' : [':Telescope colorschemes'                        , 'colorschemes'],
      ...
      \ 'p' : [':Telescope planets'                             , 'loclist'],
      \ 'r' : [':Telescope old_files'                           , 'recent-files'],
      \ 'R' : [':Telescope reloader'                            , 'loclist'],
