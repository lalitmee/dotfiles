...
" fp is for previewers
let g:which_key_map.f.p = {
      \ 'name' : '+previewers'                                 ,
      \ 'c' : [':Telescope previewers.cat.new'                 , 'cat'],
      \ 'C' : [':Telescope previewers.vim_buffer_cat.new'      , 'buffer-cat'],
      \ 'v' : [':Telescope previewers.vimgrep.new'             , 'vimgrep'],
      \ 'V' : [':Telescope previewers.vim_buffer_vimgrep.new'  , 'buffer-vimgrep'],
      \ 'q' : [':Telescope previewers.qflist.new'              , 'quickfix-list'],
      \ 'Q' : [':Telescope previewers.vim_buffer_qflist.new'   , 'buffer-qflist'],
      \ }
...
let g:which_key_map.f.s = {
      ...
      \ 'i' : [':Telescope sorters.fuzzy_with_index_bias'      , 'fuzzy-with-index'],
      \ 'l' : [':Telescope sorters.get_levenshtein_sorter'     , 'sort-levenshtein'],
      \ 's' : [':Telescope sorters.get_generic_fuzzy_sorter'   , 'sort-generic-fuzzy'],
      \ }

" ft is for sorters
let g:which_key_map.f.t = {
      \ 'name' : '+telescope-themes'                           ,
      \ 't' : [':Telescope themes.get_dropdown'                , 'select-theme'],
      \ }
