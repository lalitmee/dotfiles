...
local telescope_mapper = require('lalit.telescope.mappings')
...
_ = require('lalit.lsp.status')
require('lalit.lsp.handlers')
...
local custom_attach = function(client)
  ...
  mapper('n', 'gi', 'vim.lsp.buf.implementatoin({buffer = 0})')
  mapper('n', 'gD', 'vim.lsp.buf.declaration({buffer = 0})')
  mapper('n', 'gh', 'vim.lsp.buf.signature_help({buffer = 0})')
