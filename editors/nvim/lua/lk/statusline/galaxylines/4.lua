...
local icons =
    require('galaxyline.provider_fileinfo').define_file_icon()
...
gls.left = {
  ...
  },
  {
    GitIcon = {
      ...
      condition = function()
        return condition.check_git_workspace() and
...
gls.right = {
  {
    DiagnosticError = {
      ...
      icon = '  ',
      condition = function()
        return condition.check_active_lsp() and condition.checkwidth()
      end,
      highlight = { colors.red, colors.black }
    }
  },
