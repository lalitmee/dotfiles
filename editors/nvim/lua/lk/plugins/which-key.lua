...
local leader_key_maps = {
  ...
  ['c'] = {
    ...
    ['H'] = {
      ':Lspsaga signaute_help<CR>',
      'signature-help',
     },
    ['o'] = {
      ':Lspsaga open_floatterm<CR>',
      'open-floatterm',
     },
    ['p'] = {
  ...
  ['f'] = {
    ...
    ['l'] = {
      ...
      ['t'] = {
        ':FzfTypeDefinitions<CR>',
        'type-definition',
       },
      ['w'] = {
        ':FzfDocumentSymbols<CR>',
        'document-symbols',
       },
      ['W'] = {
        ':FzfWorkspaceSymbols<CR>',
        'workspace-symbols',
       },
     },
    ['s'] = {
  ...
  ['g'] = {
    ...
    ['o'] = {
      ...
      ['i'] = {
        ...
        ['o'] = {
          ':Octo issue reopen<CR>',
          'reopen',
         },
        ['r'] = {
          ':Octo issue reload<CR>',
          'reload',
         },
        ['s'] = {
          ':Octo issue search<CR>',
          'search',
         },
        ['u'] = {
          ':Octo issue url<CR>',
      ...
      ['l'] = {
        ...
        ['c'] = {
          ':Octo label create<CR>',
          'create',
         },
        ['r'] = {
          ':Octo label remove<CR>',
          'remove',
         },
       },
      ['p'] = {
  ...
  ['G'] = {
    ...
    ['n'] = {
      ':GonvimWorkspaceNext<CR>',
      'next-workspace',
     },
    ['N'] = {
      ':GonvimWorkspaceNew<CR>',
      'create-new-workspace',
     },
    ['p'] = {
      ':GonvimWorkspacePrevious<CR>',
      'previous-workspace',
     },
    ['r'] = {
      ':GonvimFuzzyResume<CR>',
      'resume-previous-search',
     },
    ['s'] = {
      ':GonvimWorkspaceSwitch <CR>',
      'switch-workspace',
     },
    ['w'] = {
      ':GonvimFuzzyAgCword<CR>',
      'fuzzy-word',
     },
   },
  ...
  ['l'] = {
    ...
    ['o'] = {
      ...
      ['c'] = {
        ':AerialTreeCloseAll<CR>',
        'aerial-close-all',
       },
      ['o'] = {
        ':AerialTreeOpenAll<CR>',
        'aerial-open-all',
       },
      ['s'] = {
        ':SymbolsOutline<CR>',
    ...
    ['w'] = {
      ['name'] = '+workspace',
      ['a'] = {
        ':LspAddToWorkspaceFolder<CR>',
        'add-folder-to-workspace',
       },
      ['l'] = {
        ':LspListWorkspaceFolders<CR>',
  ...
  ['L'] = {
    ...
    ['A'] = {
      ':LspRangeCodeActions<CR>',
      'range-code-action',
     },
    ['e'] = {
      ['name'] = '+diagnostics',
      ['a'] = {
        ':LspGetAllDiagnostics<CR>',
        'all-diagnostics',
       },
      ['l'] = {
        ':LspShowLineDiagnostics<CR>',
        'show-line-diagnostics',
       },
      ['n'] = {
        ':LspGotoNextDiagnostic<CR>',
        'next-diagnostic',
       },
      ['N'] = {
        ':LspGetNextDiagnostic<CR>',
        'get-next-diagnostic',
       },
      ['p'] = {
        ':LspGotoPrevDiagnostic<CR>',
        'prev-diagnostic',
       },
      ['P'] = {
        ':LspGetPrevDiagnostic<CR>',
        'get-prev-diagnostic',
       },
     },
    ['f'] = {
      ...
      ['r'] = {
        ':LspRangeFormatting<CR>',
        'range-formatting',
       },
      ['s'] = {
        ':LspFormattingSync<CR>',
        'formatting-sync',
       },
     },
    ['g'] = {
  ...
  ['N'] = {
    ...
    ['n'] = {
      ':lua require"neuron".goto_next_extmark()<CR>',
      'next',
     },
    ['p'] = {
      ':lua require"neuron".goto_next_extmark()<CR>',
    ...
    ['t'] = {
      ':lua require"neuron/telescope".find_tags()<CR>',
      'find-tags',
     },
    ['z'] = {
  ...
  ['o'] = {
    ...
    ['d'] = {
      ['name'] = '+dap',
      ['b'] = {
        ':Telescope dap lsp_breakpoints<CR>',
        'lsp-breakpoints',
       },
      ['c'] = {
    ...
    ['i'] = {
      ':Telescope snippets snippets<CR>',
      'snippets',
     },
    ['j'] = {
      ':Telescope jumps jumps<CR>',
      'jumps',
     },
    ['l'] = {
    ...
    ['u'] = {
      ':Telescope ultisnips ultisnips<CR>',
      'ultisnips',
     },
    ['v'] = {
      ['name'] = '+vim',
  ...
  ['P'] = {
    ...
    ['b'] = {
      ['name'] = '+buffers',
      ['a'] = {
        ':CocCommand fzf-preview.AllBuffers<CR>',
        'all-buffers',
       },
      ['b'] = {
      ...
      ['t'] = {
        ':CocCommand fzf-preview.BufferTags<CR>',
        'buffer-tags',
       },
      ['v'] = {
    ...
    ['f'] = {
      ['name'] = '+files',
      ['p'] = {
        ':CocCommand fzf-preview.ProjectFiles<CR>',
        'project-files',
       },
      ['g'] = {
        ':CocCommand fzf-preview.GitFiles<CR>',
        'git-files',
       },
      ['d'] = {
      ...
      ['O'] = {
        ':CocCommand fzf-preview.OldFiles<CR>',
        'old-files',
       },
      ['r'] = {
      ...
      ['R'] = {
        ':CocCommand fzf-preview.MruFiles<CR>',
        'mru-files',
       },
      ['w'] = {
      ...
      ['W'] = {
        ':CocCommand fzf-preview.MrwFiles<CR>',
        'mrw-files',
       },
     },
    ['g'] = {
      ...
      ['b'] = {
        ':CocCommand fzf-preview.GitBranches',
        'git-branches',
       },
      ['B'] = {
      ...
      ['S'] = {
        ':CocCommand fzf-preview.GitStatusActions',
        'git-status-actions',
       },
      ['l'] = {
        ':CocCommand fzf-preview.GitLogs',
        'git-logs',
       },
      ['L'] = {
        ':CocCommand fzf-preview.GitCurrentLogs',
        'git-current-logs',
       },
      ['h'] = {
        ':CocCommand fzf-preview.GitStashes',
        'git-stashes',
       },
      ['H'] = {
        ':CocCommand fzf-preview.GitStashActions',
        'git-stash-actions',
       },
      ['g'] = {
        ':CocCommand fzf-preview.GitLogActions',
        'git-log-actions',
       },
     },
    ['j'] = {
      ':CocCommand fzf-preview.Jumps<CR>',
      'jumps',
     },
    ['l'] = {
      ':CocCommand fzf-preview.LocationList<CR>',
      'location-list',
     },
    ['m'] = {
    ...
    ['M'] = {
      ':CocCommand fzf-preview.BlamePR<CR>',
      'blame-pr',
     },
    ['p'] = {
      ['name'] = '+project',
      ...
      ['s'] = {
        ':CocCommand fzf-preview.ProjectGrep<CR>',
        'project-grep',
       },
      ['S'] = {
    ...
    ['t'] = {
      ':CocCommand fzf-preview.TodoComments<CR>',
      'todo-comments',
     },
    ['v'] = {
      ':CocCommand fzf-preview.VistCtags<CR>',
      'vista-ctags',
     },
   },
  ...
  ['T'] = {
    ...
    ['r'] = {
      ':VtrReattachRunner<CR>',
      'open-runner',
     },
    ['R'] = {
      ':VtrReorientRunner<CR>',
      'reorient-runner',
     },
    ['s'] = {
      ['name'] = '+send-command',
  ...
  ['w'] = {
    ...
    ['f'] = {
      ...
      ['p'] = {
        ':lua require("harpoon.mark").promote()<CR>',
        'promote',
       },
      ['s'] = {
    ...
    ['l'] = {
      ':lua require("Navigator").right()<CR>',
      'window-right',
     },
    ['L'] = {
      '<C-W>5>',
    ...
    ['n'] = {
      '<C-W>J',
      'move-window-far-down',
     },
    ['p'] = {
      ':lua require("Navigator").previous()<CR>',
      'window-previous',
     },
    ['s'] = {
      '<C-W>s',
...
wk.register(
  local_leader_key_maps, {
    prefix = '<localleader>',
   }
 )
wk.register(
  local_leader_plug_keymaps, {
    prefix = '<localleader>',
   }
 )
wk.register(
