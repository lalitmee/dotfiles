...
map('v', '<leader>', [[:silent <c-u> :silent WhichKeyVisual '<Space>'<CR> ]], opts)
...
local leader_key_maps = {
  ...
  ['c'] = {
    ...
    ['m'] = {
      ...
      ['e'] = {':CocFzfList diagnostics --current-buf<CR>', 'buffer-diagnostics'},
...
wk.register_keymap('leader', plug_keymaps, {
  noremap = false
})
