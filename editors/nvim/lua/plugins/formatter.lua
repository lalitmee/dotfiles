...
local luafmt = function()
    return {
        exe = 'lua-format',
        args = {
            '--align-args', '--align-parameter',
            '--no-keep-simple-control-block-one-line',
            '--break-after-functioncall-lp', '--break-before-functioncall-rp',
            '--column-limit=80', '--double-quote-to-single-quote ',
            '--indent-width=2', '--no-single-quote-to-double-quote',
            '--no-use-tab', '--spaces-inside-table-braces', '--tab-width=2',
            '--chop-down-parameter', ' --no-keep-simple-function-one-line',
            '--break-after-functiondef-lp', '--break-before-functiondef-rp',
            '--align-table-field', '--break-after-table-lb',
            '--break-before-table-rb ', '--chop-down-table',
            '--chop-down-kv-table'
