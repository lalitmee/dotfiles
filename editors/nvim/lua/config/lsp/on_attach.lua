...
local function on_attach(client)
    ...
    telescope_mapper('grd', 'lsp_document_symbols', {ignore_filename = true},
                     true)
    telescope_mapper('grw', 'lsp_workspace_symbols', {ignore_filename = true},
                     true)
    telescope_mapper('grs', 'lsp_workspace_symbols',
