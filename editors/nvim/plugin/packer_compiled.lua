...
if vim.fn.exists(":TZAtaraxisOn") ~= 2 then
...
if vim.fn.exists(":TZFocusOn") ~= 2 then
...
if vim.fn.exists(":TZMinimalistOn") ~= 2 then
...
if vim.fn.exists(":TrainUpDown") ~= 2 then
...
if vim.fn.exists(":TrainWord") ~= 2 then
...
if vim.fn.exists(":TrainTextObj") ~= 2 then
...
if vim.fn.exists(":NarrowRegion") ~= 2 then
...
if vim.fn.exists(":NarrowWindow") ~= 2 then
...
if vim.fn.exists(":CheatWithouComments") ~= 2 then
...
if vim.fn.exists(":CheatList") ~= 2 then
...
if vim.fn.exists(":CheatListWithoutComments") ~= 2 then
...
if vim.fn.exists(":OpenGithubFile") ~= 2 then
...
if vim.fn.exists(":OpenGithubProject") ~= 2 then
...
if vim.fn.exists(":OpenGithubPullReq") ~= 2 then
...
if vim.fn.exists(":OpenGithubCommit") ~= 2 then
...
if vim.fn.exists(":OpenGithubIssue") ~= 2 then
...
if vim.fn.exists(":NvimTreeFindResize") ~= 2 then
...
if vim.fn.exists(":GitMessenger") ~= 2 then
