...
local no_errors, error_msg = pcall(function()
  ...
  local install_cpath_pattern =
      '/home/lalitmee/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so'
  ...
  local function try_loadstring(s, component, name)
    ...
    if not success then
      vim.schedule(function()
        vim.api.nvim_notify('packer.nvim: Error running ' .. component ..
                                ' for ' .. name .. ': ' .. result,
  ...
  _G.packer_plugins = {
    ...
    ['goyo.vim'] = {
      ...
      loaded = false,
      needs_bufread = false,
      path = '/home/lalitmee/.local/share/nvim/site/pack/packer/opt/goyo.vim'
    },
    ['gruvbuddy.nvim'] = {
      loaded = true,
