...
_G.packer_plugins = {
  ...
  ["session-lens"] = {
    config = { "\27LJ\2\nf\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\17prompt_title\17Yay Sessions\14previewer\1\nsetup\17session-lens\frequire\0" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/session-lens"
  },
  snap = {
    loaded = true,
