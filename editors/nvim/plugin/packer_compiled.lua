...
if vim.fn.exists(":TZAtaraxis") == 0 then
...
if vim.fn.exists(":TZAtaraxisOn") == 0 then
...
if vim.fn.exists(":CheatWithouComments") == 0 then
...
if vim.fn.exists(":CheatList") == 0 then
...
if vim.fn.exists(":CheatListWithoutComments") == 0 then
...
if vim.fn.exists(":TrainUpDown") == 0 then
...
if vim.fn.exists(":TrainWord") == 0 then
...
if vim.fn.exists(":NarrowRegion") == 0 then
...
if vim.fn.exists(":TZFocus") == 0 then
...
if vim.fn.exists(":TZFocusOn") == 0 then
...
if vim.fn.exists(":NvimTreeFindFile") == 0 then
...
if vim.fn.exists(":NvimTreeFindResize") == 0 then
...
if vim.fn.exists(":NvimTreeClipboard") == 0 then
...
if vim.fn.exists(":TZMinimalist") == 0 then
...
if vim.fn.exists(":TZMinimalistOn") == 0 then
...
if vim.fn.exists(":OpenGithubFile") == 0 then
...
if vim.fn.exists(":OpenGithubProject") == 0 then
...
if vim.fn.exists(":OpenGithubPullReq") == 0 then
...
if vim.fn.exists(":OpenGithubCommit") == 0 then
...
if vim.fn.exists(":OpenGithubIssue") == 0 then
...
if vim.fn.exists(":NarrowWindow") == 0 then
...
if vim.fn.exists(":LazyGitFilter") == 0 then
...
if vim.fn.exists(":LazyGitConfig") == 0 then
...
if vim.fn.exists(":TrainTextObj") == 0 then
