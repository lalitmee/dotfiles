...
Draft a professional email based on the user's context.

## CRITICAL FORMAT REQUIREMENTS

1. Provide complete, send-ready email drafts
2. Include subject line suggestions
3. Offer tone and structure variations for different audiences
4. Proofread for grammar, spelling, and clarity
5. Format output as clearly labeled email drafts
...
Provide a complete, professional email draft ready to send, along with subject line suggestions and any relevant alternatives or modifications.
