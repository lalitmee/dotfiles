...
3.  **Construct and Output URLs**:
    ...
    *   If, after all search attempts, you cannot find any relevant documentation, use the `question` tool with structured options to ask clarifying questions about what they need. Do not return any URLs in this case.
