...
local leader_key_maps = {
  ...
  ['c'] = {
    ...
    ['t'] = {
      ...
      ['E'] = {':Telescope coc workspace_diagnostics<CR>', 'workspace-diagnostics'},
  ...
  ['e'] = {
    ...
    ['L'] = {':Telescope coc workspace_diagnostics<CR>', 'workspace_diagnostics'},
  ...
  ['P'] = {
    ...
    ['b'] = {
      ...
      ['v'] = {':CocCommand fzf-preview.VistaBufferCtags<CR>', 'vista-buffer-ctags'}
    },
    ...
    ['f'] = {
      ...
      ['o'] = {':CocCommand fzf-preview.ProjectOldFiles<CR>', 'project-old-files'},
      ['O'] = {':CocCommand fzf-preview.OldFiles<CR>', 'old-files'},
      ['r'] = {':CocCommand fzf-preview.ProjectMruFiles<CR>', 'project-mru-files'},
      ['R'] = {':CocCommand fzf-preview.MruFiles<CR>', 'mru-files'},
      ['w'] = {':CocCommand fzf-preview.ProjectMrwFiles<CR>', 'project-mrw-files'},
    ...
    ['g'] = {
      ...
      ['B'] = {':CocCommand fzf-preview.GitBrancheActions', 'git-branch-actions'},
    ...
    ['p'] = {
      ...
      ['S'] = {':CocCommand fzf-preview.ProjectGrepRecall<CR>', 'project-grep-recall'},
      ['w'] = {':CocCommand fzf-preview.ProjectMrwFiles<CR>', 'project-mrw-files'}
    },
