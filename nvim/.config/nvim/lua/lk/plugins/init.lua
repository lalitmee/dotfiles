...
require("packer").startup({
  function(use)
    ...
    use({ "kevinhwang91/nvim-bqf", config = load_config("lk/plugins/nvim-bqf") })
    ...
    -- display search matches as vitual text
    use({
    ...
    use({
      ...
      config = load_config("lk/plugins/nvim_lsp"),
      requires = {
        { "onsails/lspkind-nvim" },
        { "tami5/lspsaga.nvim", config = load_config("lk/plugins/lspsaga") },
        {
          "hrsh7th/nvim-cmp",
