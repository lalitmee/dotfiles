...
return require('packer').startup {
    function(use)
        ...
        use {
            ...
            requires = {{'onsails/lspkind-nvim'}, {'tami5/lspsaga.nvim'}, {
                ...
                'hrsh7th/nvim-cmp',
                requires = {{'hrsh7th/cmp-buffer'}, {'hrsh7th/cmp-nvim-lsp'}, {'hrsh7th/cmp-nvim-lua'},
                            {'hrsh7th/cmp-path'}, {
                    'petertriho/cmp-git',
                ...
                }, {'quangnguyen30192/cmp-nvim-ultisnips'}, {'f3fora/cmp-spell'}, {'ray-x/cmp-treesitter'},
                            {'hrsh7th/cmp-emoji'}}
