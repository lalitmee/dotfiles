...
vim.cmd([[nnoremap <leader>Ff :lua TJ_GREP.grep_for_string(vim.fn.input("Grep For > "))<CR>]])
vim.cmd([[nnoremap <leader>FF :lua TJ_GREP.replace_string(vim.fn.input("Grep For > "), vim.fn.input("Replace with > "))<CR>]])
