...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-nvim-lsp", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-project.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "project.nvim" },
    commands = { "Telescope" },
