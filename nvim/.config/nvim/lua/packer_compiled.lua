...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-tabnine", "cmp-nvim-lsp", "cmp-emoji", "cmp-cmdline", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "session-lens", "telescope-ui-select.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-file-browser.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-surround', 'vim-repeat', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
