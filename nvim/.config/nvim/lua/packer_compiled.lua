...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "lsp_signature.nvim", "lspkind.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim" },
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'go.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
