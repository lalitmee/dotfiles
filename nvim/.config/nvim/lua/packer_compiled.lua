...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-dap.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
