...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "copilot-cmp", "LuaSnip", "cmp-buffer", "cmp_luasnip", "cmp-emoji", "cmp-nvim-lsp", "cmp-tabnine" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "one-small-step-for-vimkind", "telescope-dap.nvim", "nvim-dap-ui" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "octo.nvim", "telescope-repo.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-surround', 'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
