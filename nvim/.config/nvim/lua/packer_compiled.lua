...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-media-files.nvim" },
