...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim" },
