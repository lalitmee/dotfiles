...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-context", "playground", "nvim-ts-rainbow", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-media-files.nvim" },
