...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "playground", "iswap.nvim", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-github.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-live-grep-args.nvim", "session-lens" },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TSJSplit lua require("packer.load")({'treesj'}, { cmd = "TSJSplit", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TSJJoin lua require("packer.load")({'treesj'}, { cmd = "TSJJoin", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file FSToggle lua require("packer.load")({'fsread.nvim'}, { cmd = "FSToggle", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'auto-session', 'nvim-treesitter', 'vim-wakatime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
