...
_G.packer_plugins = {
  ...
  ["cder.nvim"] = {
    config = { "\27LJ\2\nI\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\1K\0\1\0\tcder\19load_extension\14telescope\frequire\0" },
    load_after = {
      ["telescope.nvim"] = true
    },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/cder.nvim",
  ...
  ["cmp-plugins"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/cmp-plugins",
  ...
  ["headlines.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/headlines.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-emoji", "LuaSnip", "cmp-path", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-plugins", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "one-small-step-for-vimkind", "nvim-dap-virtual-text", "nvim-dap-ui" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lspkind.nvim", "lua-dev.nvim", "lsp_signature.nvim", "fidget.nvim" },
  ...
  ["nvim-spotify"] = {
    config = { "R('lk/plugins/spotify')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/nvim-spotify",
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "neogen", "refactoring.nvim", "nvim-treesitter-textobjects" },
  ...
  ["org-bullets.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/org-bullets.nvim",
  ...
  ["org-capture-filetype"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/org-capture-filetype",
  ...
  ["orgWiki.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/orgWiki.nvim",
    url = "https://github.com/ranjithshegde/orgWiki.nvim"
  },
  orgmode = {
    after = { "org-capture-filetype", "orgWiki.nvim", "headlines.nvim", "vim-table-mode" },
    loaded = true,
    only_config = true
  },
  ["packer.nvim"] = {
  ...
  ["telescope-ag"] = {
    config = { "\27LJ\2\nG\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\1K\0\1\0\aag\19load_extension\14telescope\frequire\0" },
    load_after = {
      ["telescope.nvim"] = true
    },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/telescope-ag",
  ...
  ["telescope-changes.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/telescope-changes.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-changes.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "session-lens", "refactoring.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ag", "cder.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-table-mode"] = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/vim-table-mode",
...
local module_lazy_loads = {
  ...
  ["^telescope%._extensions%.ag"] = "telescope-ag",
  ["^telescope%._extensions%.cder"] = "cder.nvim",
  ["^telescope%._extensions%.changes"] = "telescope-changes.nvim",
  ...
  ["^telescope%._extensions%.hop"] = "telescope-hop.nvim",
  ...
  ["^telescope%._extensions%.repo"] = "telescope-repo.nvim",
...
vim.cmd [[ packadd org-capture-filetype ]]
vim.cmd [[ packadd vim-table-mode ]]
vim.cmd [[ packadd headlines.nvim ]]
vim.cmd [[ packadd orgWiki.nvim ]]
...
vim.cmd [[au FileType org ++once lua require("packer.load")({'org-bullets.nvim', 'nvim-treesitter'}, { ft = "org" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'lua-dev.nvim', 'cmp-nvim-lua', 'nvim-treesitter'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType norg ++once lua require("packer.load")({'neorg', 'nvim-treesitter'}, { ft = "norg" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'nvim-lspconfig', 'nvim-treesitter', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'vim-repeat', 'FastFold', 'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
