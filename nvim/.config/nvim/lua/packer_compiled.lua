...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-plugins" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "neogen", "nvim-treesitter-textobjects", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-changes.nvim", "cder.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "session-lens", "telescope-dap.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'vim-surround', 'vim-repeat', 'FastFold', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
