...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
