...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "ultisnips", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "lualine-lsp-progress", "lspkind-nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "session-lens", "git-worktree.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
