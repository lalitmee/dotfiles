...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp_luasnip", "cmp-cmdline" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-textobjects", "playground", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "howdoi.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-zoxide", "octo.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
