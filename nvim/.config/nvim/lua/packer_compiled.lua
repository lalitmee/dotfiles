...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "iswap.nvim", "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "howdoi.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-live-grep-args.nvim", "telescope-fzf-native.nvim" },
