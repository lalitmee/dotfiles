...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp_luasnip", "cmp-tabnine", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "git-worktree.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
