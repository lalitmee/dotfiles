...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "howdoi.nvim", "telescope-zoxide", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-fzf-native.nvim", "session-lens", "git-worktree.nvim", "telescope-file-browser.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'Comment.nvim', 'null-ls.nvim', 'nvim-nonicons', 'nvim-treesitter', 'nvim-bufferline.lua', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
