...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lua", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "neodim", "iswap.nvim", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-github.nvim", "telescope-ui-select.nvim", "telescope-live-grep-args.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "session-lens" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'auto-session', 'vim-wakatime', 'nvim-treesitter'}, { event = "VimEnter *" }, _G.packer_plugins)]]
