...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-tabnine", "cmp-buffer", "cmp-plugins", "LuaSnip", "cmp-emoji", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-ag", "cder.nvim", "octo.nvim", "refactoring.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'glow.nvim', 'nvim-treesitter', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-repeat', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
