...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "neodim", "iswap.nvim", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-github.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-treesitter', 'auto-session', 'vim-wakatime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
