...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "octo.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
