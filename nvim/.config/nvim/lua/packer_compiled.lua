...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    after_files = { "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/copilot-cmp/after/plugin/copilot_cmp.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    after = { "copilot-cmp" },
    config = { "R('lk/plugins/copilot')" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/copilot.lua",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine", "copilot-cmp", "LuaSnip", "cmp_luasnip", "cmp-emoji", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lua-dev.nvim", "fidget.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "refactoring.nvim", "neogen", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "octo.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-changes.nvim", "telescope-ag", "telescope-hop.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'nvim-treesitter', 'markdown-preview.nvim', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
