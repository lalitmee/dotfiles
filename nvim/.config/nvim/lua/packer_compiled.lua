...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-cmdline", "cmp-emoji", "LuaSnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "telescope-ag", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'markdown-preview.nvim', 'glow.nvim', 'nvim-treesitter'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'nvim-bufferline.lua', 'gitsigns.nvim', 'vim-surround', 'nvim-treesitter', 'vim-repeat', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
