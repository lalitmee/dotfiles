...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "octo.nvim", "telescope-dap.nvim", "session-lens", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
