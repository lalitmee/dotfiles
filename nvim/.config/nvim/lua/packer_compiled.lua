...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-emoji", "cmp-cmdline", "cmp-plugins", "cmp-tabnine", "LuaSnip", "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-nvim-lsp" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-ui", "telescope-dap.nvim", "nvim-dap-virtual-text" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "neogen", "playground", "nvim-ts-context-commentstring", "refactoring.nvim" },
  ...
  orgmode = {
    after = { "headlines.nvim", "org-capture-filetype", "orgWiki.nvim", "vim-table-mode" },
    loaded = true,
    only_config = true
  },
  ["packer.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "howdoi.nvim", "session-lens", "octo.nvim", "telescope-dap.nvim", "telescope-hop.nvim", "telescope-repo.nvim", "telescope-luasnip.nvim", "cder.nvim", "telescope-media-files.nvim", "telescope-gitmoji.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter', 'vim-repeat', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
