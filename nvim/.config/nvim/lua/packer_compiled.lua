...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lua", "cmp-emoji", "LuaSnip", "cmp-buffer", "cmp-path", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "fidget.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "refactoring.nvim", "nvim-treesitter-textobjects", "neogen", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "octo.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'indent-blankline.nvim', 'vim-surround', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
