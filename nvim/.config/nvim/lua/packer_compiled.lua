...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-frecency.nvim", "session-lens", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
  ...
  ["vim-tpipeline"] = {
    config = { "\27LJ\2\nY\0\0\2\0\4\0\t6\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0)\1\1\0=\1\3\0K\0\1\0\22tpipeline_restore\26tpipeline_cursormoved\6g\bvim\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\nY\0\0\2\0\4\0\t6\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0)\1\1\0=\1\3\0K\0\1\0\22tpipeline_restore\26tpipeline_cursormoved\6g\bvim\0", "config", "vim-tpipeline")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'vim-surround', 'vim-repeat', 'nvim-treesitter', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
