...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-tabnine", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "dim.lua", "diaglist.nvim", "lsp_signature.nvim", "lua-dev.nvim", "lualine-lsp-progress" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "dim.lua", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "project.nvim", "git-worktree.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-media-files.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'FastFold', 'indent-blankline.nvim', 'vim-surround', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
