...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-media-files.nvim" },
