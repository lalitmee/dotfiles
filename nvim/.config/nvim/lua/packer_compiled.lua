...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-rg", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "session-lens", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'nvim-treesitter', 'Comment.nvim', 'indent-blankline.nvim', 'null-ls.nvim', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
