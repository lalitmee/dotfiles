...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-ts-rainbow", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "howdoi.nvim", "session-lens", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "octo.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-nonicons', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
