...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-rg" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'Comment.nvim', 'vim-repeat', 'gitsigns.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
