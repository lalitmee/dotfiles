...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "session-lens", "refactoring.nvim", "octo.nvim", "howdoi.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-treesitter', 'vim-surround', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'copilot.lua', 'vim-wakatime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
