...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp_luasnip", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "nvim-treesitter-context", "nvim-ts-rainbow", "iswap.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim" },
