...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-rg", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-zoxide", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'nvim-nonicons', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
