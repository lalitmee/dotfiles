...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-emoji", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "nvim-dap-ui", "telescope-dap.nvim", "one-small-step-for-vimkind" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim", "neogen" },
  ...
  ["persisted.nvim"] = {
    config = { "R('lk/plugins/persisted')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/persisted.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "octo.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'cmp-nvim-lua', 'nvim-treesitter', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-treesitter', 'glow.nvim', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'tidy.nvim'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-nonicons', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
