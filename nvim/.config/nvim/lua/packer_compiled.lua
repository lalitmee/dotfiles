...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-live-grep-args.nvim", "telescope-github.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim" },
