...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-rainbow", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-zoxide", "telescope-ui-select.nvim", "git-worktree.nvim", "session-lens", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-nonicons', 'nvim-treesitter', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
