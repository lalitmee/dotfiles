...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "octo.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-repeat', 'gitsigns.nvim', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
