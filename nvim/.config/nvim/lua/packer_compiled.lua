...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "howdoi.nvim", "session-lens", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
