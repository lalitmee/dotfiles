...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "iswap.nvim", "nvim-treesitter-context", "nvim-ts-rainbow", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "howdoi.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim" },
