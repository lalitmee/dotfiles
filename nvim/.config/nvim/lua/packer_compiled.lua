...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "git-worktree.nvim", "howdoi.nvim" },
