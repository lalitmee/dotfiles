...
_G.packer_plugins = {
  ...
  ["copilot.lua"] = {
    after = { "copilot-cmp" },
    config = { "require('lk/plugins/copilot')" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
  ...
  ["fold-cycle.nvim"] = {
    ...
    config = { "require('lk/plugins/fold-cycle')" },
    keys = { { "", "n" }, { "", "<TAB>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["neo-tree.nvim"] = {
    ...
    config = { "require('lk/plugins/neo-tree')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  neorg = {
    commands = { "Neorg" },
    config = { "require('lk/plugins/neorg')" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "copilot-cmp", "cmp-cmdline", "cmp-nvim-lsp", "cmp-tabnine", "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lspkind-nvim", "fidget.nvim", "diaglist.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "neogen", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-repo.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-hop.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "session-lens" },
    commands = { "Telescope" },
  ...
  ["zen-mode.nvim"] = {
    commands = { "ZenMode" },
    config = { "require('lk/plugins/zen-mode')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[inoremap <silent> " <cmd>lua require("packer.load")({'nvim-autopairs'}, { keys = "\"" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> <TAB> <cmd>lua require("packer.load")({'fold-cycle.nvim'}, { keys = "<lt>TAB>", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'markdown-preview.nvim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'lua-dev.nvim', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-treesitter', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
