...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-frecency.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "telescope-zoxide" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-bufferline.lua', 'vim-repeat', 'indent-blankline.nvim', 'null-ls.nvim', 'nvim-nonicons', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
