...
_G.packer_plugins = {
  ...
  harpoon = {
    commands = { "HarpoonAddFile", "HarpoonGotoFile1", "HarpoonGotoFile2", "HarpoonGotoFile3", "HarpoonGotoFile4", "HarpoonGotoFile5", "HarpoonGotoFile6", "HarpoonGotoFile7", "HarpoonGotoFile8", "HarpoonGotoFile9", "HarpoonGotoTerm1", "HarpoonGotoTerm2", "HarpoonGotoTerm3", "HarpoonNextMark", "HarpoonPrevMark", "HarpoonRemoveFile", "ToggleHarpoonMenu" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-cmdline", "cmp-path", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lsp_signature.nvim", "lspkind.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "playground", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "git-worktree.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au FileType markdown_inline ++once lua require("packer.load")({'nvim-treesitter'}, { ft = "markdown_inline" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-lspconfig', 'go.nvim', 'nvim-treesitter'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'nvim-treesitter', 'vim-repeat', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
