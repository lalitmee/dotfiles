...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "git-worktree.nvim" },
