...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind-nvim", "fidget.nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-repo.nvim", "telescope-hop.nvim", "telescope-dap.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "octo.nvim", "refactoring.nvim", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-treesitter', 'nvim-bufferline.lua', 'gitsigns.nvim', 'indent-blankline.nvim', 'FastFold', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
