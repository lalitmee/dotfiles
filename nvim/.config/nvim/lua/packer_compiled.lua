...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "lspkind.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "refactoring.nvim", "neogen", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "git-worktree.nvim", "howdoi.nvim", "refactoring.nvim", "octo.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-bufferline.lua', 'nvim-nonicons', 'nvim-treesitter', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
