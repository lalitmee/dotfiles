...
_G.packer_plugins = {
  ...
  ["leap.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim" },
