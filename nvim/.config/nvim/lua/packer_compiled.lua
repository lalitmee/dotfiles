...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "cmp-nvim-lua", "cmp-path", "LuaSnip", "copilot-cmp", "cmp-cmdline", "cmp-nvim-lsp", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "fidget.nvim", "diaglist.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "refactoring.nvim", "nvim-ts-context-commentstring", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-repo.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-hop.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'nvim-lspconfig', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'glow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
