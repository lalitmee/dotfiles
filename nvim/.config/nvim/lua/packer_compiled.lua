...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-dap.nvim" },
