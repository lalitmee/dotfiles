...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neogen", "nvim-treesitter-textobjects", "refactoring.nvim", "playground", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-gitmoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-repeat', 'vim-surround', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
