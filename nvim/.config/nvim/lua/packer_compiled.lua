...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-emoji", "LuaSnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "diaglist.nvim", "fidget.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-treesitter-textobjects", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "howdoi.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "session-lens", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-luasnip.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'vim-repeat', 'gitsigns.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
