...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-dap.nvim" },
