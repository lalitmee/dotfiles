...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-rg" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-file-browser.nvim", "session-lens", "telescope-frecency.nvim", "howdoi.nvim", "octo.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'nvim-treesitter', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
