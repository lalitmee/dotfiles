...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-zoxide", "octo.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim" },
  ...
  ["which-key.nvim"] = {
    ...
    url = "https://github.com/xaviervalarino/which-key.nvim"
  },
  ["yanky.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-repeat', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
