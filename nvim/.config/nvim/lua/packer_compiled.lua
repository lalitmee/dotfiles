...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\24NeogitCommitMessage\1\14gitcommit\1\20TelescopePrompt\1\18DressingInput\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lua", "cmp-tabnine", "cmp-plugins", "cmp_luasnip", "cmp-nvim-lsp", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "diaglist.nvim", "lsp_signature.nvim", "lspkind.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "refactoring.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  orgmode = {
    after = { "orgWiki.nvim", "vim-table-mode", "org-capture-filetype", "headlines.nvim" },
    loaded = true,
    only_config = true
  },
  ["packer.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "cder.nvim", "refactoring.nvim", "octo.nvim", "session-lens", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-searchindex"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/vim-searchindex",
...
try_loadstring("\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\24NeogitCommitMessage\1\14gitcommit\1\20TelescopePrompt\1\18DressingInput\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter', 'glow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'cmp-nvim-lua', 'nvim-treesitter', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'vim-repeat', 'vim-surround', 'nvim-bufferline.lua', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
