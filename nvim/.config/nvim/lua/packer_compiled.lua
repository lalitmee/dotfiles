...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-frecency.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'glow.nvim', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
