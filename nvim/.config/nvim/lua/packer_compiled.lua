...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-project.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "nvim-neoclip.lua", "project.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
