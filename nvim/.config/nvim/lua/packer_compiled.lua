...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim", "session-lens", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'Comment.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'nvim-nonicons', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
