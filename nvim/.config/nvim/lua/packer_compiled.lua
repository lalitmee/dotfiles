...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "git-worktree.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim" },
