...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "LuaSnip", "cmp-tabnine", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lualine-lsp-progress", "lspkind-nvim", "diaglist.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-tmux.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "octo.nvim", "telescope-emoji.nvim", "git-worktree.nvim", "session-lens", "workspaces.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
