...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip", "LuaSnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "session-lens", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "refactoring.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "git-worktree.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
