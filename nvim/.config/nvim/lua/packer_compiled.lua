...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-frecency.nvim", "howdoi.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-zoxide" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'null-ls.nvim', 'nvim-nonicons', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
