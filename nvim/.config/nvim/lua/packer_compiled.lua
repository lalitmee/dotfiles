...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-cmdline", "cmp-emoji", "cmp-buffer", "copilot-cmp", "LuaSnip", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-treesitter-textobjects", "refactoring.nvim", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "octo.nvim", "telescope-repo.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "session-lens", "refactoring.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold', 'gitsigns.nvim', 'vim-surround', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
