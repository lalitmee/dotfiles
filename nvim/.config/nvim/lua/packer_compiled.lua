...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "LuaSnip", "cmp_luasnip", "cmp-tabnine", "cmp-emoji", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "lualine-lsp-progress", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-tmux.nvim", "workspaces.nvim", "telescope-smart-history.nvim", "octo.nvim", "telescope-emoji.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'FastFold', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
