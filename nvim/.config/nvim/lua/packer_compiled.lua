...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "neogen", "nvim-ts-context-commentstring", "refactoring.nvim", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim", "refactoring.nvim", "octo.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
