...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-emoji" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "refactoring.nvim", "playground", "nvim-treesitter-textobjects", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-luasnip.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-smart-history.nvim", "octo.nvim", "telescope-media-files.nvim", "telescope-dap.nvim", "telescope-gitmoji.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
