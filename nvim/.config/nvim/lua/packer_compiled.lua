...
_G.packer_plugins = {
  ...
  ["howdoi.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/howdoi.nvim",
  ...
  ["telescope-live-grep-args.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/telescope-live-grep-args.nvim",
