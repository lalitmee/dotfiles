...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "neogen", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
