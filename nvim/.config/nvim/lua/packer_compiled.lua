...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "cmp-buffer" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "nvim-treesitter-context", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "session-lens", "telescope-zoxide", "telescope-dap.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-smart-history.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-bufferline.lua', 'null-ls.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
