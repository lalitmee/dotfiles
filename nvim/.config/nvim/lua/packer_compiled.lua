...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp-rg", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-rainbow", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "howdoi.nvim", "octo.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "git-worktree.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'Comment.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
