...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-live-grep-args.nvim", "telescope-github.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "git-worktree.nvim" },
