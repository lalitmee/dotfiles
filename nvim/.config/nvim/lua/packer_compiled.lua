...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "iswap.nvim", "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-rainbow", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "session-lens", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
