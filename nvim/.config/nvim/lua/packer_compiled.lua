...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "refactoring.nvim", "octo.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-luasnip.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-gitmoji.nvim", "telescope-dap.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'FastFold', 'nvim-nonicons', 'vim-repeat', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
