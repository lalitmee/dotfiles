...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-cmdline", "cmp-tabnine", "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "cmp-rg", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "diaglist.nvim", "lua-dev.nvim", "lspkind.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "session-lens", "git-worktree.nvim", "howdoi.nvim", "octo.nvim", "telescope-zoxide" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'Comment.nvim', 'indent-blankline.nvim', 'vim-repeat', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
