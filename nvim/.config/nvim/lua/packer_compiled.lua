...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim" },
