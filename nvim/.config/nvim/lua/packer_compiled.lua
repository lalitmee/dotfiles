...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-cmdline", "cmp-nvim-lsp", "cmp-emoji", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "dim.lua", "lua-dev.nvim", "lualine-lsp-progress", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "dim.lua", "playground", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "octo.nvim", "project.nvim", "session-lens", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'gitsigns.nvim', 'nvim-nonicons', 'vim-surround', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
