...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-nvim-lsp", "cmp-emoji" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "telescope-dap.nvim", "nvim-dap-ui", "one-small-step-for-vimkind" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-treesitter-textobjects", "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "octo.nvim", "session-lens", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-bufferline.lua', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-treesitter', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
