...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-dap.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim" },
