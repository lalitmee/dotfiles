...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-emoji", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
