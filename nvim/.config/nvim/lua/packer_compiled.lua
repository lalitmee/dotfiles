...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "cmp-emoji", "cmp-tabnine", "LuaSnip", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "diaglist.nvim", "lspkind-nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-ag", "telescope-frecency.nvim", "telescope-repo.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-dap.nvim", "telescope-gitmoji.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "octo.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-changes.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter', 'markdown-preview.nvim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-bufferline.lua', 'vim-surround', 'FastFold', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
