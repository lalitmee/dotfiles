...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "LuaSnip", "cmp-emoji", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "lua-dev.nvim", "diaglist.nvim", "lspkind-nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "telescope-ag", "telescope-repo.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "octo.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'cmp-nvim-lua', 'lua-dev.nvim', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-surround', 'FastFold', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
