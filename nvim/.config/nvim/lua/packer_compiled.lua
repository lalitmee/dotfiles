...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip", "cmp-path", "cmp-tabnine", "cmp-rg", "cmp-nvim-lua", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-zoxide", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "octo.nvim", "git-worktree.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'Comment.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
