...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lua", "LuaSnip", "cmp-emoji", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "octo.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-emoji.nvim", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'vim-surround', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
