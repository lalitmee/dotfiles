...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\14gitcommit\1\24NeogitCommitMessage\1\18DressingInput\1\20TelescopePrompt\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["go.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/go.nvim",
  ...
  ["neovim-cmake"] = {
    config = { "R('lk/plugins/neovim-cmake')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/neovim-cmake",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-virtual-text", "one-small-step-for-vimkind", "nvim-dap-ui" },
    loaded = true,
    only_config = true
  },
  ["nvim-dap-ui"] = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "lspkind.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "session-lens" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
try_loadstring("\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\14gitcommit\1\24NeogitCommitMessage\1\18DressingInput\1\20TelescopePrompt\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-lspconfig', 'glow.nvim', 'nvim-treesitter'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'vim-repeat', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
