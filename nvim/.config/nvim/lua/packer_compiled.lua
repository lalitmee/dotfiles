...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "iswap.nvim", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "git-worktree.nvim", "telescope-dap.nvim", "telescope-live-grep-args.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "howdoi.nvim" },
