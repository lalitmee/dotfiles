...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground", "nvim-ts-rainbow", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "session-lens", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
