...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "fidget.nvim", "lsp_signature.nvim", "lspkind.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-treesitter-textobjects", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "refactoring.nvim", "session-lens", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-hop.nvim", "howdoi.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "octo.nvim", "cder.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspconfig', 'cmp-nvim-lua', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspconfig', 'glow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'nvim-treesitter'}, { ft = "cpp" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround', 'indent-blankline.nvim', 'vim-repeat', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
