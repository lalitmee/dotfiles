...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-emoji", "cmp-tabnine", "LuaSnip", "cmp-buffer", "cmp_luasnip", "cmp-cmdline", "cmp-plugins", "cmp-path", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "neogen", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
  ...
  orgmode = {
    after = { "org-capture-filetype", "vim-table-mode", "orgWiki.nvim", "headlines.nvim" },
    loaded = true,
    only_config = true
  },
  ["packer.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-file-browser.nvim", "git-worktree.nvim", "octo.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "telescope-luasnip.nvim", "telescope-changes.nvim", "telescope-ag", "telescope-frecency.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "cder.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-repeat', 'FastFold', 'nvim-treesitter', 'vim-surround', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
