...
_G.packer_plugins = {
  ...
  neoformat = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/neoformat",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-tabnine", "cmp-emoji", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lua-dev.nvim", "lsp_signature.nvim", "fidget.nvim" },
  ...
  ["rest.nvim"] = {
    config = { "R('lk/plugins/rest')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/rest.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-frecency.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-treesitter', 'markdown-preview.nvim', 'glow.nvim', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-nonicons', 'nvim-treesitter', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
