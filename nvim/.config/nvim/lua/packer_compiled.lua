...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-rg", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
