...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "session-lens", "refactoring.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'glow.nvim', 'markdown-preview.nvim', 'nvim-treesitter'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-surround', 'FastFold', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
