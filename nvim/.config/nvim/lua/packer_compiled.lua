...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    config = { "\27LJ\2\n˜\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\17handler_opts\1\0\1\vborder\frounded\1\0\4\21auto_close_after\3\15\tbind\2\ffix_pos\1\16hint_enable\1\nsetup\18lsp_signature\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-tmuxinator.nvim", "nvim-neoclip.lua", "telescope-lsp-handlers.nvim", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "project.nvim", "telescope-media-files.nvim" },
    commands = { "Telescope" },
