...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-treesitter-context", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "howdoi.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "session-lens", "telescope-frecency.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'vim-repeat', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
