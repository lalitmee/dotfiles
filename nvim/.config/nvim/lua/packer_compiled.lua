...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-buffer", "cmp-tabnine", "LuaSnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-emoji", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim", "lspkind.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-treesitter-textobjects", "neogen", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "cder.nvim", "telescope-file-browser.nvim", "telescope-ag", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'FastFold', 'nvim-nonicons', 'nvim-bufferline.lua', 'vim-surround', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
