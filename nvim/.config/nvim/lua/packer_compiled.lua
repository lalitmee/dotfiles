...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lsp_signature.nvim", "lua-dev.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "refactoring.nvim", "telescope-gitmoji.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
