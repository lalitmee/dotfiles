...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "fidget.nvim", "diaglist.nvim", "lsp_signature.nvim", "lspkind.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "neogen", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "octo.nvim", "session-lens", "telescope-dap.nvim", "cder.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-changes.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround', 'vim-repeat', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
