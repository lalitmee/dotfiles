...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-rg", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-cmdline", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "session-lens", "telescope-zoxide", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-repeat', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
