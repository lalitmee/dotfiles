...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-treesitter-context", "playground", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "session-lens", "telescope-frecency.nvim", "telescope-zoxide", "howdoi.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-file-browser.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-nonicons', 'null-ls.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
