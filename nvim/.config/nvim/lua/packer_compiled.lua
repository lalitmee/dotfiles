...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-emoji", "cmp-cmdline", "cmp-nvim-lsp", "ultisnips", "cmp-tabnine", "cmp-nvim-ultisnips" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lua-dev.nvim", "lsp_signature.nvim", "lspkind-nvim", "lualine-lsp-progress" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "refactoring.nvim", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "session-lens", "telescope-file-browser.nvim", "octo.nvim", "telescope-hop.nvim", "project.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
