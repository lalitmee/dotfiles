...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-path", "cmp-tabnine", "LuaSnip", "cmp-cmdline", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim", "lualine-lsp-progress", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neogen", "refactoring.nvim", "playground", "nvim-treesitter-textobjects" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-media-files.nvim", "octo.nvim", "project.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-surround', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
