...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp-emoji", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind.nvim", "lua-dev.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim", "playground", "neogen" },
  ...
  ["nvim-ufo"] = {
    config = { "\27LJ\2\nË\1\0\0\6\0\f\0\0196\0\0\0'\2\1\0B\0\2\0029\1\2\0005\3\3\0B\1\2\0016\1\4\0009\1\5\1'\3\6\0009\4\a\0'\5\b\0B\1\4\0016\1\4\0009\1\5\1'\3\t\0009\4\n\0'\5\v\0B\1\4\1K\0\1\0\20close all folds\18closeAllFolds\azM\19open all folds\17openAllFolds\azR\rnnoremap\alk\1\0\1\25open_fold_hl_timeout\3\0\nsetup\bufo\frequire\0" },
    loaded = true,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "git-worktree.nvim", "refactoring.nvim", "octo.nvim", "howdoi.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-frecency.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-repeat', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
