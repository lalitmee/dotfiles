...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-tabnine", "LuaSnip", "cmp-nvim-lsp", "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "refactoring.nvim", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-media-files.nvim", "octo.nvim", "project.nvim", "git-worktree.nvim", "workspaces.nvim", "session-lens", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
