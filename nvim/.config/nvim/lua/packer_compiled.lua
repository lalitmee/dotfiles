...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "cmp-rg", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "diaglist.nvim", "lsp_signature.nvim", "lspkind.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-zoxide", "telescope-dap.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
