...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    config = { "\27LJ\2\n˜\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\17handler_opts\1\0\1\vborder\frounded\1\0\4\ffix_pos\1\16hint_enable\1\21auto_close_after\3\15\tbind\2\nsetup\18lsp_signature\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-buffer" },
  ...
  ["nvim-revJ.lua"] = {
    ...
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/nvim-revJ.lua",
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "session-lens", "telescope-file-browser.nvim", "project.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-lsp-handlers.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "telescope-hop.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'nvim-lspconfig'}, { ft = "jsx" }, _G.packer_plugins)]]
