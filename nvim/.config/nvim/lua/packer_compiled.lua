...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp-path", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "octo.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'vim-repeat', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
