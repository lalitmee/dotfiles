...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip", "cmp-cmdline", "cmp-tabnine", "cmp-path", "cmp-buffer" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "session-lens", "howdoi.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
