...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "neogen", "refactoring.nvim", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "refactoring.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-repeat', 'nvim-treesitter', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
