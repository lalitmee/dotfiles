...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-media-files.nvim" },
