...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-dap.nvim", "session-lens", "telescope-frecency.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-zoxide", "octo.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'Comment.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'null-ls.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
