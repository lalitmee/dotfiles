...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "LuaSnip", "cmp-emoji", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "fidget.nvim", "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "neogen", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "session-lens", "octo.nvim", "cder.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-lspconfig', 'cmp-nvim-lua', 'nvim-treesitter'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
