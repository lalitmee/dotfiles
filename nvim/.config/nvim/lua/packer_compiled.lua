...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "iswap.nvim", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "telescope-github.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-dap.nvim", "session-lens", "telescope-fzf-native.nvim" },
