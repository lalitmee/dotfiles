...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-treesitter-context", "playground", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-smart-history.nvim" },
