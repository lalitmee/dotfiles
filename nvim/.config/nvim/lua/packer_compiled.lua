...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\20TelescopePrompt\1\14gitcommit\1\24NeogitCommitMessage\1\18DressingInput\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-emoji", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "one-small-step-for-vimkind", "nvim-dap-ui", "nvim-dap-virtual-text" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "fidget.nvim", "lspkind.nvim" },
  ...
  ["nvim-spectre"] = {
    commands = { "SpectreOpen", "SpectreCurWord", "SpectreVisual", "SpectreCurFileSearch" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects" },
  ...
  ["packer.nvim"] = {
    ...
    url = "https://github.com/akinsho/packer.nvim"
  },
  playground = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "session-lens", "git-worktree.nvim", "telescope-fzf-native.nvim", "howdoi.nvim" },
...
try_loadstring("\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\20TelescopePrompt\1\14gitcommit\1\24NeogitCommitMessage\1\18DressingInput\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
time([[Config for copilot.vim]], false)
-- Config for: trouble.nvim
time([[Config for trouble.nvim]], true)
R('lk/plugins/trouble')
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file SpectreCurFileSearch lua require("packer.load")({'nvim-spectre'}, { cmd = "SpectreCurFileSearch", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file SpectreVisual lua require("packer.load")({'nvim-spectre'}, { cmd = "SpectreVisual", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file SpectreCurWord lua require("packer.load")({'nvim-spectre'}, { cmd = "SpectreCurWord", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.api.nvim_set_keymap("", "n", "<cmd>lua require('packer.load')({'fold-cycle.nvim'}, { keys = [=[n]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "{", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[{]=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-y>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-y>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "gb", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gb]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "(", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[(]=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<M-h>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-h>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-f>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-f>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "<C-\\>", "<cmd>lua require('packer.load')({'nvim-toggleterm.lua'}, { keys = [=[<lt>C-\\>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gbc", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gbc]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "`", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[`]=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "-", "<cmd>lua require('packer.load')({'lir.nvim'}, { keys = [=[-]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "zb", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[zb]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "*", "<cmd>lua require('packer.load')({'vim-visual-star-search'}, { keys = [=[*]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gbO", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gbO]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "gs", "<cmd>lua require('packer.load')({'vim-sort-motion'}, { keys = [=[gs]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-k>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-k>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "zz", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[zz]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "<CR>", "<cmd>lua require('packer.load')({'fold-cycle.nvim'}, { keys = [=[<lt>CR>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gbA", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gbA]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "v", "<cmd>lua require('packer.load')({'vim-visual-star-search'}, { keys = [=[v]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-j>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-j>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "zt", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[zt]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "n", "<cmd>lua require('packer.load')({'nvim-toggleterm.lua'}, { keys = [=[n]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "gc", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gc]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gS", "<cmd>lua require('packer.load')({'splitjoin.vim'}, { keys = [=[gS]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "\"", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[\"]=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-h>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-h>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "i", "<cmd>lua require('packer.load')({'cmp-emoji'}, { keys = [=[i]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gJ", "<cmd>lua require('packer.load')({'splitjoin.vim'}, { keys = [=[gJ]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<M-l>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-l>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<M-k>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-k>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gco", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gco]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<M-j>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-j>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "'", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[']=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "n", "<cmd>lua require('packer.load')({'lir.nvim'}, { keys = [=[n]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-b>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-b>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-l>", "<cmd>lua require('packer.load')({'nvim-gomove'}, { keys = [=[<lt>M-l>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-e>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-e>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-u>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-u>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gs", "<cmd>lua require('packer.load')({'vim-sort-motion'}, { keys = [=[gs]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", ":", "<cmd>lua require('packer.load')({'cmp-emoji'}, { keys = [=[:]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "[", "<cmd>lua require('packer.load')({'nvim-autopairs'}, { keys = [=[[]=] }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "gcc", "<cmd>lua require('packer.load')({'Comment.nvim'}, { keys = [=[gcc]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-d>", "<cmd>lua require('packer.load')({'neoscroll.nvim'}, { keys = [=[<lt>C-d>]=], prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-repeat', 'nvim-nonicons', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
