...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-nvim-lua", "cmp-emoji", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "dim.lua", "neogen", "refactoring.nvim", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-tmuxinator.nvim", "telescope-emoji.nvim", "telescope-ui-select.nvim", "nvim-neoclip.lua", "octo.nvim", "git-worktree.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "session-lens", "telescope-media-files.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "project.nvim", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
