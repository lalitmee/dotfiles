...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-rg", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-context", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "session-lens", "howdoi.nvim", "telescope-frecency.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'vim-repeat', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
