...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-path", "cmp-emoji", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-smart-history.nvim", "telescope-media-files.nvim", "workspaces.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "octo.nvim", "telescope-emoji.nvim", "telescope-tmux.nvim", "project.nvim", "git-worktree.nvim", "telescope-hop.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'FastFold', 'vim-surround', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
