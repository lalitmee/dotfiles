...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-zoxide", "session-lens", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-repeat', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
