...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp_luasnip", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-zoxide", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-repeat', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
