...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim" },
