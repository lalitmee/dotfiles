...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-zoxide", "telescope-dap.nvim", "telescope-frecency.nvim" },
  ...
  ["vim-lastplace"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/vim-lastplace",
