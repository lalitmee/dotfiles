...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-buffer", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "lualine-lsp-progress", "lsp_signature.nvim", "diaglist.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "project.nvim", "telescope-frecency.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
