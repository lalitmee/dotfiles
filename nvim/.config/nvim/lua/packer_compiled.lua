...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-file-browser.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
