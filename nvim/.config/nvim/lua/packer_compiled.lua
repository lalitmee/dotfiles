...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "telescope-frecency.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
