...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-tmux.nvim", "project.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-tmuxinator.nvim", "telescope-project.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-smart-history.nvim", "nvim-neoclip.lua", "telescope-hop.nvim" },
    commands = { "Telescope" },
