...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-cmdline", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "dim.lua", "lsp_signature.nvim", "lualine-lsp-progress", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "dim.lua", "playground", "neogen", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "nvim-neoclip.lua", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-bufferline.lua', 'FastFold', 'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
