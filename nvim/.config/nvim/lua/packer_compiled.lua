...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-zoxide" },
