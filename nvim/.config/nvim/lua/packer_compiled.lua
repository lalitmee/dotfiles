...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tabnine", "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp_luasnip", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-luasnip.nvim", "telescope-dap.nvim", "telescope-gitmoji.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "howdoi.nvim", "octo.nvim", "telescope-fzf-native.nvim", "session-lens" },
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-treesitter', 'go.nvim', 'nvim-lspconfig'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-bufferline.lua', 'vim-repeat', 'nvim-treesitter', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
