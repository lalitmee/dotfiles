...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-zoxide", "telescope-media-files.nvim", "howdoi.nvim", "telescope-fzf-native.nvim" },
