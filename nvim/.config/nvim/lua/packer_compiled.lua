...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp_luasnip", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-zoxide", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'nvim-treesitter', 'Comment.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
