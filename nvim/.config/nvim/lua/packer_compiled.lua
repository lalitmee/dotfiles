...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspkind.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-frecency.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-repeat', 'nvim-treesitter', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
