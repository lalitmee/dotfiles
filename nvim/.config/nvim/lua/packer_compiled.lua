...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "iswap.nvim", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "howdoi.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "telescope-github.nvim" },
