...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "refactoring.nvim", "neogen", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "cder.nvim", "howdoi.nvim", "session-lens", "octo.nvim", "telescope-dap.nvim", "telescope-ag", "telescope-ui-select.nvim", "telescope-changes.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
