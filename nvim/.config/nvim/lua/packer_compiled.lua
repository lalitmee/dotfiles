...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "session-lens", "howdoi.nvim", "octo.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua', 'nvim-nonicons', 'FastFold', 'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
