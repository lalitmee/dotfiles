...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "octo.nvim", "session-lens", "git-worktree.nvim", "howdoi.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-treesitter', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
