...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-cmdline", "cmp-buffer", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "neodim", "playground", "nvim-treesitter-context", "nvim-ts-rainbow", "iswap.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "howdoi.nvim", "session-lens", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim" },
