...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp_luasnip", "cmp-cmdline", "cmp-rg", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-dap.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim", "octo.nvim", "telescope-file-browser.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'gitsigns.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
