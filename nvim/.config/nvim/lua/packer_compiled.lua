...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-dap.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'markdown-preview.nvim', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
