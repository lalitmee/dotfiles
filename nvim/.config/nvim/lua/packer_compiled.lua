...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "iswap.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-dap.nvim", "git-worktree.nvim", "howdoi.nvim" },
