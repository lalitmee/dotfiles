...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    config = { "\27LJ\2\n˜\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\17handler_opts\1\0\1\vborder\frounded\1\0\4\21auto_close_after\3\15\16hint_enable\1\ffix_pos\1\tbind\2\nsetup\18lsp_signature\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-nvim-ultisnips" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "octo.nvim", "project.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-tmux.nvim", "telescope-emoji.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "session-lens", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'nvim-treesitter', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'gitsigns.nvim', 'FastFold', 'indent-blankline.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-wakatime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'dressing.nvim', 'pretty-fold.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
