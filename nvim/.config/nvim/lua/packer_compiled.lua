...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "iswap.nvim", "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "session-lens" },
