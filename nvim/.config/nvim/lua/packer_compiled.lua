...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lsp_signature.nvim", "fidget.nvim", "lspkind.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
