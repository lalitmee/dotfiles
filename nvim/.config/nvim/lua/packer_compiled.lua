...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim" },
