...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp_luasnip", "cmp-path", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "howdoi.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'Comment.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
