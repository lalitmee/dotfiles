...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "lspkind.nvim", "fidget.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-repo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "cder.nvim", "telescope-ag", "howdoi.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'vim-repeat', 'nvim-treesitter', 'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
