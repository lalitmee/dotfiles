...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lspkind-nvim", "lua-dev.nvim", "lualine-lsp-progress", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neogen", "refactoring.nvim", "playground" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-media-files.nvim", "session-lens", "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
