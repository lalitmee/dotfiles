...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-cmdline", "cmp-nvim-lsp", "cmp-tabnine", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind-nvim", "diaglist.nvim", "lualine-lsp-progress", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "octo.nvim", "session-lens", "project.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
