...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-path", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "refactoring.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround', 'vim-repeat', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
