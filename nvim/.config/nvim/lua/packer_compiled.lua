...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "git-worktree.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
