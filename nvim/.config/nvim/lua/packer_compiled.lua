...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "session-lens", "telescope-ui-select.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-gitmoji.nvim", "refactoring.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-nonicons', 'nvim-bufferline.lua', 'gitsigns.nvim', 'vim-surround', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
