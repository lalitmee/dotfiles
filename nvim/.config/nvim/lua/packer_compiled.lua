...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "octo.nvim", "git-worktree.nvim" },
