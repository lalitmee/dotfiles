...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp-nvim-lua" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "git-worktree.nvim", "project.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-openbrowser.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-tmuxinator.nvim", "telescope-project.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
