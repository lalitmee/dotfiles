...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-dap.nvim", "howdoi.nvim" },
