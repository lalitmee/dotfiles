...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "copilot-cmp", "cmp-tabnine", "cmp_luasnip", "LuaSnip", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "diaglist.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "refactoring.nvim", "neogen", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "octo.nvim", "git-worktree.nvim", "telescope-dap.nvim", "refactoring.nvim", "telescope-repo.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
