...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-rg", "cmp-tabnine", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'Comment.nvim', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
