...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lualine-lsp-progress", "diaglist.nvim", "dim.lua", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "refactoring.nvim", "nvim-treesitter-textobjects", "neogen", "dim.lua", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "nvim-neoclip.lua", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua', 'vim-surround', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
