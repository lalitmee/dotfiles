...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "neogen", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim", "refactoring.nvim", "session-lens", "telescope-dap.nvim", "octo.nvim", "telescope-frecency.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-repeat', 'gitsigns.nvim', 'vim-surround', 'indent-blankline.nvim', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
