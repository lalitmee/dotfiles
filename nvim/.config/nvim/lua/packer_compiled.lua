...
_G.packer_plugins = {
  ...
  ["neo-tree.nvim"] = {
    commands = { "NeoTreeFocusToggle", ":NeoTreeFloatToggle", ":NeoTreeShowInSplit", ":NeoTreeRevealInSplit" },
    config = { "R('lk/plugins/neo-tree')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/neo-tree.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-tabnine", "LuaSnip", "cmp_luasnip", "cmp-emoji", "cmp-path" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-ui", "nvim-dap-virtual-text", "one-small-step-for-vimkind" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspkind-nvim", "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "refactoring.nvim", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-changes.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "session-lens", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
pcall(vim.cmd, [[au CmdUndefined :NeoTreeFloatToggle ++once lua require"packer.load"({'neo-tree.nvim'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined :NeoTreeShowInSplit ++once lua require"packer.load"({'neo-tree.nvim'}, {}, _G.packer_plugins)]])
...
pcall(vim.cmd, [[au CmdUndefined :NeoTreeRevealInSplit ++once lua require"packer.load"({'neo-tree.nvim'}, {}, _G.packer_plugins)]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-lspconfig', 'nvim-treesitter', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-nonicons', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
