...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-emoji", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-buffer" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "session-lens", "telescope-frecency.nvim", "telescope-ui-select.nvim", "octo.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'nvim-treesitter', 'vim-repeat', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
