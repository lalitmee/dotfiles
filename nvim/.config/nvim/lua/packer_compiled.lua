...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
