...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "dim.lua", "lua-dev.nvim", "lsp_signature.nvim", "diaglist.nvim", "lualine-lsp-progress" },
    loaded = true,
    only_config = true
  },
  ["nvim-neoclip.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "dim.lua", "refactoring.nvim", "neogen" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "nvim-neoclip.lua", "telescope-tmuxinator.nvim", "telescope-file-browser.nvim", "octo.nvim", "telescope-hop.nvim", "git-worktree.nvim", "session-lens", "telescope-tmux.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
