...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua", "cmp-rg", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lspkind.nvim", "lsp_signature.nvim", "lua-dev.nvim", "fidget.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'vim-repeat', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
