...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "neodim", "nvim-treesitter-textobjects", "iswap.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "session-lens", "telescope-ui-select.nvim" },
