...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "iswap.nvim", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "telescope-github.nvim", "session-lens", "howdoi.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim" },
