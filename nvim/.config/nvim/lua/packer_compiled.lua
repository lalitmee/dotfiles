...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp_luasnip", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-buffer" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "one-small-step-for-vimkind", "telescope-dap.nvim", "nvim-dap-virtual-text" },
    loaded = true,
    only_config = true
  },
  ["nvim-dap-ui"] = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind.nvim", "fidget.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "refactoring.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'glow.nvim', 'nvim-treesitter', 'nvim-lspconfig'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'indent-blankline.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
