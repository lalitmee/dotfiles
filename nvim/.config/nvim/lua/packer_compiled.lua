...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp_luasnip", "LuaSnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-path", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "fidget.nvim", "lspkind.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "refactoring.nvim", "neogen", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-changes.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-ag", "telescope-dap.nvim", "session-lens", "git-worktree.nvim", "refactoring.nvim", "telescope-luasnip.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
