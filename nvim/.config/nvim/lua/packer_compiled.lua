...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-nvim-lua", "cmp-emoji", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-changes.nvim", "telescope-fzf-native.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "session-lens", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "telescope-gitmoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'FastFold', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
