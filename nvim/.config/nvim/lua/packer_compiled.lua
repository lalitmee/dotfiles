...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "session-lens", "telescope-dap.nvim", "octo.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-treesitter', 'Comment.nvim', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
