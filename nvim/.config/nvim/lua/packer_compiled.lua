...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "diaglist.nvim", "lspkind.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "octo.nvim", "howdoi.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-zoxide", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-repeat', 'indent-blankline.nvim', 'Comment.nvim', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
