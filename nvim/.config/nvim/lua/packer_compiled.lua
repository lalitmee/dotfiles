...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp-nvim-lsp", "LuaSnip", "cmp-cmdline", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "lua-dev.nvim", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "telescope-dap.nvim", "session-lens", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'FastFold', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
