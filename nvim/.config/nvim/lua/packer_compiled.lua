...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-live-grep-args.nvim", "telescope-dap.nvim", "howdoi.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim" },
