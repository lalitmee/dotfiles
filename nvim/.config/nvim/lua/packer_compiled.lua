...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
