...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-treesitter-textobjects", "playground", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "refactoring.nvim", "octo.nvim", "session-lens", "git-worktree.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-repeat', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
