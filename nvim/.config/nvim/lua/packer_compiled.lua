...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip", "cmp-rg", "cmp-cmdline", "cmp-path", "cmp-tabnine", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "playground", "nvim-treesitter-textobjects", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-zoxide", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "octo.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'Comment.nvim', 'nvim-treesitter', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
