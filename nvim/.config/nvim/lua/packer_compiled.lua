...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-emoji", "cmp_luasnip", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-virtual-text", "one-small-step-for-vimkind", "telescope-dap.nvim" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "fidget.nvim", "lspkind-nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-changes.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-repo.nvim", "octo.nvim", "telescope-luasnip.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-ag", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-dap.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
