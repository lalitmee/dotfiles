...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-nvim-lsp", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "project.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-openbrowser.nvim", "telescope-tmuxinator.nvim", "telescope-project.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "nvim-neoclip.lua" },
    commands = { "Telescope" },
