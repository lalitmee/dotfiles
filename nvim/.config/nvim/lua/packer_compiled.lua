...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "session-lens", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
