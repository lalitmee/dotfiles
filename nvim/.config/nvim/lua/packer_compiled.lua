...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-tabnine", "cmp-path", "cmp-buffer", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "session-lens", "howdoi.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim" },
