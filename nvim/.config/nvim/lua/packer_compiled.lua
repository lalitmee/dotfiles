...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "copilot-cmp", "LuaSnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-path", "cmp-nvim-lua", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
