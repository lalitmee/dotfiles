...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-emoji", "cmp-nvim-lua", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lsp", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "dim.lua", "lua-dev.nvim", "lualine-lsp-progress", "lsp_signature.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "dim.lua", "refactoring.nvim", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-tmuxinator.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "project.nvim", "session-lens", "octo.nvim", "telescope-ui-select.nvim", "nvim-neoclip.lua", "telescope-emoji.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
