...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-live-grep-args.nvim", "telescope-github.nvim", "telescope-ui-select.nvim" },
