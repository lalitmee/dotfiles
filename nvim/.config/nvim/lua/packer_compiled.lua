...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neogen", "playground", "refactoring.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "git-worktree.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
