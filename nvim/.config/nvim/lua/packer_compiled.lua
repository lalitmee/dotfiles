...
_G.packer_plugins = {
  ["AbbrevMan.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/AbbrevMan.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-ultisnips", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lualine-lsp-progress", "dim.lua", "lsp_signature.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "dim.lua", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "project.nvim", "nvim-neoclip.lua", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "telescope-hop.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
