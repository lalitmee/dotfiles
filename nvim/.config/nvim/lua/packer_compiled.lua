...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-path", "cmp_luasnip", "cmp-rg", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-zoxide" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-nonicons', 'vim-repeat', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
