...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-nvim-lua", "cmp-buffer", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "iswap.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "session-lens", "telescope-github.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-live-grep-args.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-frecency.nvim" },
