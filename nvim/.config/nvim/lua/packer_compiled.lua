...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "ultisnips", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lua-dev.nvim", "lualine-lsp-progress", "lsp_signature.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-ts-context-commentstring", "refactoring.nvim" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-file-browser.nvim", "octo.nvim", "telescope-hop.nvim", "project.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
