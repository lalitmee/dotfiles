...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "fidget.nvim", "lspkind.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-repeat', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
