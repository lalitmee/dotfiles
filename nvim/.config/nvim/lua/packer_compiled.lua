...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp_luasnip", "cmp-tabnine", "cmp-nvim-lsp", "cmp-emoji", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "howdoi.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'vim-repeat', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-surround', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
