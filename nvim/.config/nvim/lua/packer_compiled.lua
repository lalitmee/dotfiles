...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "iswap.nvim", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim" },
