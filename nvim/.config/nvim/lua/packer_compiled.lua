...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lua", "cmp-path", "cmp-emoji", "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "octo.nvim", "session-lens", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'FastFold', 'gitsigns.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
