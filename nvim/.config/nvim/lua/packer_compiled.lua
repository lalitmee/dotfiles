...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-dap.nvim", "session-lens", "octo.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'vim-repeat', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
