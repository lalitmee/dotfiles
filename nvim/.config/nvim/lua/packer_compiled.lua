...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-tabnine", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-context", "playground", "neodim", "iswap.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-ui-select.nvim", "telescope-live-grep-args.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "howdoi.nvim" },
