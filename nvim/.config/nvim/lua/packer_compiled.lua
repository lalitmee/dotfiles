...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "howdoi.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "session-lens", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'vim-repeat', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
