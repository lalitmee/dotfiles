...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow", "nvim-treesitter-context", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-zoxide", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "git-worktree.nvim" },
