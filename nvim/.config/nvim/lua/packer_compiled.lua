...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
