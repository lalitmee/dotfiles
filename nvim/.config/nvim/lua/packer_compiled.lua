...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "cmp-cmdline-history", "cmp-rg", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-zoxide", "octo.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'null-ls.nvim', 'nvim-bufferline.lua', 'Comment.nvim', 'vim-repeat', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
