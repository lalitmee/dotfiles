...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-ultisnips" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "refactoring.nvim", "neogen", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "octo.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "session-lens", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-surround', 'indent-blankline.nvim', 'gitsigns.nvim', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
