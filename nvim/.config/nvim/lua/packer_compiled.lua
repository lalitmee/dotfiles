...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "iswap.nvim", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-github.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-live-grep-args.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim" },
