...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-emoji", "ultisnips" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "lspkind-nvim", "lua-dev.nvim", "lualine-lsp-progress" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "refactoring.nvim", "playground" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "project.nvim", "octo.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
  ...
  ultisnips = {
    after_files = { "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/ultisnips/after/plugin/UltiSnips_after.vim" },
    commands = { "UltiSnipsEdit", "UltiSnipsAddFiletypes" },
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/ultisnips",
...
try_loadstring("\27LJ\2\nV\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\2\14gitcommit\1\24NeogitCommitMessage\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file UltiSnipsEdit lua require("packer.load")({'ultisnips'}, { cmd = "UltiSnipsEdit", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file UltiSnipsAddFiletypes lua require("packer.load")({'ultisnips'}, { cmd = "UltiSnipsAddFiletypes", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
