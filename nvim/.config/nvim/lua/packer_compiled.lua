...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "copilot-cmp", "cmp-tabnine", "LuaSnip", "cmp_luasnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "telescope-dap.nvim", "nvim-dap-virtual-text", "one-small-step-for-vimkind" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "fidget.nvim", "lua-dev.nvim", "lspkind-nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "session-lens", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'vim-surround', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
