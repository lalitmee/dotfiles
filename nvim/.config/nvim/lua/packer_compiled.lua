...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-cmdline" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "refactoring.nvim", "playground", "neogen", "nvim-ts-context-commentstring", "dim.lua" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "nvim-neoclip.lua", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "octo.nvim", "project.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'gitsigns.nvim', 'FastFold', 'vim-surround', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
