...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-rg", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "session-lens", "howdoi.nvim", "telescope-zoxide", "telescope-frecency.nvim", "git-worktree.nvim", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'Comment.nvim', 'vim-repeat', 'nvim-treesitter', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
