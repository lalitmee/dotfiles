...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "project.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-project.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
