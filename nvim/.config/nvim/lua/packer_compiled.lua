...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "cmp-cmdline", "cmp-rg", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-context", "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-smart-history.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-zoxide", "octo.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-nonicons', 'Comment.nvim', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
