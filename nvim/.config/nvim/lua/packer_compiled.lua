...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-path", "cmp-rg", "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "howdoi.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "session-lens", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'Comment.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
