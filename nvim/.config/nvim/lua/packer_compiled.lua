...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "neogen" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "octo.nvim", "project.nvim", "telescope-ui-select.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "session-lens", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'vim-surround', 'FastFold', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
