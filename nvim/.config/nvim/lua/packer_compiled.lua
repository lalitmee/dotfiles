...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lua-dev.nvim", "fidget.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "octo.nvim", "howdoi.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-ui-select.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
