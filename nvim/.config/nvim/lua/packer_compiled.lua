...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "nvim-neoclip.lua", "telescope-project.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-tmuxinator.nvim", "telescope-ui-select.nvim", "project.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
