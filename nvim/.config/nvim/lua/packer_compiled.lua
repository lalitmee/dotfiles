...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "neogen", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "howdoi.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "refactoring.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "octo.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-treesitter', 'nvim-lspconfig', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
