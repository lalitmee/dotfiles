...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-tabnine", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-lsp", "cmp_luasnip", "copilot-cmp", "LuaSnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "fidget.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-repo.nvim", "git-worktree.nvim", "session-lens", "refactoring.nvim", "telescope-dap.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'nvim-treesitter', 'nvim-bufferline.lua', 'vim-surround', 'gitsigns.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
