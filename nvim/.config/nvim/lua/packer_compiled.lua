...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen", "refactoring.nvim", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "telescope-luasnip.nvim", "git-worktree.nvim", "howdoi.nvim", "session-lens", "telescope-dap.nvim", "refactoring.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "octo.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'markdown-preview.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'lua-dev.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
