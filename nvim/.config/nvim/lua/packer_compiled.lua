...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-rg", "cmp_luasnip", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lsp", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "fidget.nvim", "diaglist.nvim", "lspkind.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "octo.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "telescope-zoxide", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'Comment.nvim', 'vim-repeat', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
