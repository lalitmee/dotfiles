...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspkind-nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "session-lens", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "octo.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
