...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-plugins", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim", "fidget.nvim", "lspkind.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "refactoring.nvim", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gitmoji.nvim", "git-worktree.nvim", "telescope-hop.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "howdoi.nvim", "cder.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-ag", "telescope-changes.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'cmp-nvim-lua', 'nvim-lspconfig', 'nvim-treesitter'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'FastFold', 'vim-surround', 'nvim-nonicons', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
