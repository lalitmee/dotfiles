...
_G.packer_plugins = {
  ...
  ["focus.nvim"] = {
    config = { "R('lk/plugins/focus')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/focus.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lua", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspkind.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-gitmoji.nvim", "telescope-ui-select.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
