...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "iswap.nvim", "nvim-treesitter-context", "playground", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-undo.nvim", "telescope-live-grep-args.nvim", "session-lens", "git-worktree.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-github.nvim" },
