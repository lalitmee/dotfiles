...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "one-small-step-for-vimkind", "nvim-dap-virtual-text", "telescope-dap.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-file-browser.nvim" },
