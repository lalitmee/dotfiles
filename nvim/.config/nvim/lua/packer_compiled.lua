...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-emoji", "cmp-path", "LuaSnip", "copilot-cmp", "cmp-buffer", "cmp_luasnip", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "fidget.nvim", "lspkind-nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "playground", "refactoring.nvim", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "session-lens", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
