...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer", "cmp-path", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "octo.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
