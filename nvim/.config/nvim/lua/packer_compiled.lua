...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-emoji", "cmp-tabnine", "LuaSnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "one-small-step-for-vimkind", "nvim-dap-ui", "telescope-dap.nvim" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lua-dev.nvim", "diaglist.nvim", "fidget.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "neogen", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "telescope-ui-select.nvim", "telescope-ag" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-treesitter', 'cmp-nvim-lua', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-repeat', 'nvim-bufferline.lua', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-treesitter', 'FastFold', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
