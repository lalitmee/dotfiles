...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-dap.nvim", "git-worktree.nvim", "telescope-github.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim" },
