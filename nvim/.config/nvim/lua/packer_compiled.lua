...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-tabnine", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "fidget.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "session-lens", "octo.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-file-browser.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'nvim-bufferline.lua', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
