...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "session-lens", "telescope-zoxide", "telescope-file-browser.nvim", "git-worktree.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-treesitter', 'nvim-bufferline.lua', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
