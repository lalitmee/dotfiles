...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-buffer", "cmp_luasnip", "cmp-path", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua", "cmp-rg" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-zoxide", "session-lens", "howdoi.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
