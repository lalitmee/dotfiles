...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-tabnine", "cmp-cmdline", "LuaSnip", "cmp-path", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-virtual-text", "telescope-dap.nvim", "one-small-step-for-vimkind" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "diaglist.nvim", "lspkind.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "neogen", "playground", "refactoring.nvim", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-repo.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "session-lens", "telescope-ag", "telescope-file-browser.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'FastFold', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-nonicons', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
