...
_G.packer_plugins = {
  ...
  ["mind.nvim"] = {
    ...
    url = "https://github.com/phaazon/mind.nvim.git"
  },
  neogen = {
    commands = { "Neogen" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp_luasnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "telescope-dap.nvim", "nvim-dap-ui", "nvim-dap-virtual-text" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "lspkind.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "session-lens", "octo.nvim", "telescope-dap.nvim", "git-worktree.nvim" },
  ...
  ["todo-comments.nvim"] = {
    ...
    url = "https://github.com/B4mbus/todo-comments.nvim.git"
  },
  ["true-zen.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'nvim-treesitter', 'nvim-lspconfig', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspconfig', 'lua-dev.nvim', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'vim-repeat', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
