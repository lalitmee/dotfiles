...
_G.packer_plugins = {
  ...
  buffertag = {
    config = { "R('lk/plugins/buffertag')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/buffertag",
  ...
  ["code_runner.nvim"] = {
    ...
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/code_runner.nvim",
    url = "https://github.com/CRAG666/code_runner.nvim"
  },
  ["color-picker.nvim"] = {
    config = { "R('lk/plugins/color-picker')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/color-picker.nvim",
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\24NeogitCommitMessage\1\18DressingInput\1\20TelescopePrompt\1\14gitcommit\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["forem.nvim"] = {
    commands = { "Forem" },
    config = { "R('lk/plugins/forem')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/forem.nvim",
    url = "https://github.com/Massolari/forem.nvim"
  },
  ["formatter.nvim"] = {
  ...
  ["icon-picker.nvim"] = {
    ...
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/icon-picker.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-cmdline", "cmp-path" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-virtual-text", "nvim-dap-ui", "one-small-step-for-vimkind" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lsp_signature.nvim", "fidget.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "octo.nvim", "session-lens" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
try_loadstring("\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\24NeogitCommitMessage\1\18DressingInput\1\20TelescopePrompt\1\14gitcommit\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Forem lua require("packer.load")({'forem.nvim'}, { cmd = "Forem", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter', 'lua-dev.nvim', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-treesitter', 'vim-repeat', 'nvim-bufferline.lua', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
