...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-rg", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "fidget.nvim", "lspkind.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-file-browser.nvim", "howdoi.nvim", "git-worktree.nvim", "session-lens", "telescope-zoxide", "telescope-frecency.nvim", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-repeat', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
