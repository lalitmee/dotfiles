...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-zoxide", "howdoi.nvim", "octo.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
