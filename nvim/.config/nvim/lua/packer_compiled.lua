...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-emoji", "cmp-path", "copilot-cmp", "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lua", "cmp_luasnip", "LuaSnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "lspkind-nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-hop.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-media-files.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "octo.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-lspconfig', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'vim-surround', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
