...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "lua-dev.nvim", "lspkind.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "howdoi.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-ui-select.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-lspconfig', 'markdown-preview.nvim', 'nvim-treesitter', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
