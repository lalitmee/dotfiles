...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-ultisnips", "cmp-tabnine", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "dim.lua", "diaglist.nvim", "lualine-lsp-progress", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-tmuxinator.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "git-worktree.nvim", "project.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "octo.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-surround', 'nvim-bufferline.lua', 'FastFold', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
