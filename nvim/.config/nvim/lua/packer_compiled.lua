...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\18DressingInput\1\20TelescopePrompt\1\14gitcommit\1\24NeogitCommitMessage\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-plugins", "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-emoji", "LuaSnip", "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "neogen", "nvim-ts-context-commentstring", "playground", "refactoring.nvim" },
  ...
  orgmode = {
    after = { "org-capture-filetype", "orgWiki.nvim", "vim-table-mode", "headlines.nvim" },
    loaded = true,
    only_config = true
  },
  ["packer.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "cder.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "refactoring.nvim", "octo.nvim", "telescope-file-browser.nvim", "telescope-changes.nvim" },
    commands = { "Telescope" },
...
try_loadstring("\27LJ\2\nv\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\4\18DressingInput\1\20TelescopePrompt\1\14gitcommit\1\24NeogitCommitMessage\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'lua-dev.nvim', 'nvim-lspconfig', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspconfig', 'markdown-preview.nvim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType org ++once lua require("packer.load")({'nvim-treesitter', 'org-bullets.nvim'}, { ft = "org" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'FastFold', 'vim-surround', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
