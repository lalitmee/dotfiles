...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "howdoi.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "session-lens", "octo.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'vim-repeat', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
