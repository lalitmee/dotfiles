...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "howdoi.nvim", "telescope-zoxide", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-frecency.nvim" },
