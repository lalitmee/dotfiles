...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neodim", "playground", "nvim-treesitter-context", "nvim-treesitter-textobjects", "iswap.nvim", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "session-lens", "git-worktree.nvim", "telescope-fzf-native.nvim", "howdoi.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim" },
