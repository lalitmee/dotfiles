...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-emoji", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-virtual-text", "nvim-dap-ui", "telescope-dap.nvim" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind.nvim", "fidget.nvim", "diaglist.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-media-files.nvim", "telescope-luasnip.nvim", "howdoi.nvim", "telescope-hop.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "cder.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "octo.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'nvim-treesitter', 'nvim-lspconfig', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'nvim-treesitter', 'vim-repeat', 'gitsigns.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
