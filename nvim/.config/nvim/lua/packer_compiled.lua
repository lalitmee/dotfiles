...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lualine-lsp-progress", "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim", "dim.lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "refactoring.nvim", "playground", "nvim-treesitter-textobjects", "dim.lua" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-tmux.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-tmuxinator.nvim", "project.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "session-lens", "git-worktree.nvim", "octo.nvim" },
    commands = { "Telescope" },
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
...
vim.cmd [[noremap <silent> n <cmd>lua require("packer.load")({'which-key.nvim'}, { keys = "n", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
