...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "ultisnips", "cmp-cmdline", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-ultisnips" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lspkind-nvim", "lualine-lsp-progress", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "refactoring.nvim", "neogen" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "project.nvim", "refactoring.nvim", "git-worktree.nvim", "octo.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'nvim-nonicons', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
