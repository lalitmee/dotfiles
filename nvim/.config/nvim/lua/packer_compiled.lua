...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspkind.nvim", "lua-dev.nvim", "fidget.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-changes.nvim", "cder.nvim", "telescope-ag", "telescope-smart-history.nvim", "telescope-repo.nvim", "telescope-media-files.nvim", "howdoi.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-gitmoji.nvim", "octo.nvim", "session-lens", "telescope-hop.nvim", "telescope-luasnip.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-tpipeline"] = {
    config = { "R('lk/plugins/vim-tpipeline')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/vim-tpipeline",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'nvim-lspconfig', 'markdown-preview.nvim', 'nvim-treesitter'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'cmp-nvim-lua', 'lua-dev.nvim', 'nvim-treesitter'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-repeat', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
