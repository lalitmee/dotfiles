...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp_luasnip", "cmp-path", "cmp-buffer", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "playground", "iswap.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "git-worktree.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-github.nvim", "telescope-live-grep-args.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim" },
