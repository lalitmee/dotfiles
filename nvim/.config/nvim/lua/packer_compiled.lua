...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-path", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-emoji", "LuaSnip", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "lsp_signature.nvim", "fidget.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ag", "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "telescope-hop.nvim", "telescope-repo.nvim", "telescope-changes.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-luasnip.nvim", "telescope-gitmoji.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "octo.nvim", "refactoring.nvim", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'FastFold', 'vim-surround', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
