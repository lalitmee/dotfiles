...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-path", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "fidget.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-rainbow", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "octo.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "session-lens" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-bufferline.lua', 'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
