...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "session-lens", "octo.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "howdoi.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'Comment.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'vim-repeat', 'nvim-bufferline.lua', 'null-ls.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
