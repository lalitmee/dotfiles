...
_G.packer_plugins = {
  ...
  ["animation.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/animation.nvim",
  ...
  middleclass = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/middleclass",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "git-worktree.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "howdoi.nvim", "session-lens" },
  ...
  ["windows.nvim"] = {
    config = { "R('lk.plugins.windows')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/windows.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'vim-repeat', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
