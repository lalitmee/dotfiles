...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-gitmoji.nvim", "git-worktree.nvim", "telescope-luasnip.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "refactoring.nvim", "telescope-smart-history.nvim", "octo.nvim", "howdoi.nvim", "session-lens", "telescope-fzf-native.nvim" },
    loaded = true,
    only_config = true
  },
  ["tidy.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
