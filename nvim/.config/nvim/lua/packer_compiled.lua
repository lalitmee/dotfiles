...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "ultisnips", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-nvim-lua", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lualine-lsp-progress", "diaglist.nvim", "lsp_signature.nvim", "lspkind-nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-emoji.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "project.nvim", "telescope-tmux.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
