...
_G.packer_plugins = {
  ...
  ["codewindow.nvim"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/codewindow.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "howdoi.nvim" },
