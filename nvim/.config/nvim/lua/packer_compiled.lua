...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-github.nvim", "telescope-ui-select.nvim", "howdoi.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "git-worktree.nvim" },
