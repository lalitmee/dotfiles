...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "howdoi.nvim", "telescope-dap.nvim", "telescope-live-grep-args.nvim", "telescope-fzf-native.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-github.nvim" },
