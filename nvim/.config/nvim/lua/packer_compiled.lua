...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-cmdline", "cmp-tabnine", "cmp_luasnip", "cmp-rg", "cmp-path", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind.nvim", "lua-dev.nvim", "diaglist.nvim", "lsp_signature.nvim", "fidget.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-dap.nvim", "session-lens", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "octo.nvim", "howdoi.nvim", "telescope-file-browser.nvim", "git-worktree.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'nvim-treesitter', 'vim-repeat', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
