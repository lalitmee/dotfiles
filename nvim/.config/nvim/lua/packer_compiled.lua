...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-path", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lsp", "cmp-buffer" },
  ...
  ["nvim-revJ.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/nvim-revJ.lua",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-lsp-handlers.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-tmuxinator.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "project.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[noremap <silent> gS <cmd>lua require("packer.load")({'nvim-revJ.lua'}, { keys = "gS", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[noremap <silent> n <cmd>lua require("packer.load")({'nvim-revJ.lua'}, { keys = "n", prefix = "" }, _G.packer_plugins)<cr>]]
