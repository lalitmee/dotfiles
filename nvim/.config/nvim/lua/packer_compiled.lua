...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip", "cmp-cmdline", "cmp-rg", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lspkind.nvim", "fidget.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-ui-select.nvim", "howdoi.nvim", "session-lens", "telescope-dap.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-repeat', 'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
