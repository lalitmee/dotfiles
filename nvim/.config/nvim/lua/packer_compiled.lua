...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-cmdline-history", "cmp_luasnip", "cmp-rg", "cmp-cmdline" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-zoxide", "telescope-file-browser.nvim", "howdoi.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "session-lens", "octo.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'Comment.nvim', 'nvim-bufferline.lua', 'nvim-treesitter', 'null-ls.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
