    ...
    { --[[ which-key ]]
        ...
        init = function()
            ...
            wk.add({
                ...
                --------------------------------------------------------------------------------
                { "<leader>sc", group = "grug-far-sar", mode = { "n", "v" } },
                -- }}}
                --------------------------------------------------------------------------------

                --------------------------------------------------------------------------------
                -- NOTE: <leader>ss -> spectre search  {{{
                --------------------------------------------------------------------------------
                { "<leader>ss", group = "spectre-sar", mode = { "n", "v" } },
                -- }}}
                --------------------------------------------------------------------------------
                ...
                --------------------------------------------------------------------------------
                --  NOTE: <localleader>a -> code-companion {{{
                --------------------------------------------------------------------------------
                { "<localleader>a", group = "code-companion", mode = { "n", "v" } },
                -- }}}
                --------------------------------------------------------------------------------
