...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-buffer", "LuaSnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-path", "cmp_luasnip", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-media-files.nvim", "workspaces.nvim", "telescope-hop.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-bufferline.lua', 'vim-surround', 'vim-sleuth', 'indent-blankline.nvim', 'gitsigns.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
