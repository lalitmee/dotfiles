...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-lsp", "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp-path", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "refactoring.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-ui-select.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'nvim-nonicons', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
