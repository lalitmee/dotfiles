...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "LuaSnip", "cmp-buffer", "cmp-emoji", "cmp-path", "cmp_luasnip", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "nvim-gps", "refactoring.nvim", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-dap.nvim", "refactoring.nvim", "session-lens", "telescope-smart-history.nvim", "octo.nvim", "git-worktree.nvim", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'vim-surround', 'FastFold', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
