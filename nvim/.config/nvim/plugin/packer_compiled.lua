...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/emmet-vim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "LuaSnip", "cmp-nvim-lsp", "cmp_luasnip", "cmp-emoji", "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lspkind-nvim", "lsp_signature.nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "neogen", "nvim-ts-context-commentstring", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "octo.nvim", "telescope-tmux.nvim", "workspaces.nvim", "session-lens", "telescope-frecency.nvim", "telescope-smart-history.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[noremap <silent> , <cmd>lua require("packer.load")({'emmet-vim'}, { keys = ",", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[noremap <silent> i <cmd>lua require("packer.load")({'emmet-vim'}, { keys = "i", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[inoremap <silent> { <cmd>lua require("packer.load")({'nvim-autopairs'}, { keys = "{" }, _G.packer_plugins)<cr>]]
vim.cmd [[inoremap <silent> [ <cmd>lua require("packer.load")({'nvim-autopairs'}, { keys = "[" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'vim-surround', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
