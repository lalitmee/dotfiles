...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-emoji", "cmp-nvim-lsp", "cmp-buffer", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lspkind-nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen", "playground", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "workspaces.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-hop.nvim", "octo.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'indent-blankline.nvim', 'vim-sleuth', 'gitsigns.nvim', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
