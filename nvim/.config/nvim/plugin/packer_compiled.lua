...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp-tabnine", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-treesitter-textobjects", "neogen", "playground", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "workspaces.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-hop.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'lua-dev.nvim', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
