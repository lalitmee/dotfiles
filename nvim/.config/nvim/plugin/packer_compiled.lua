...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\ne\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\3\24NeogitCommitMessage\1\18DressingInput\1\14gitcommit\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "LuaSnip", "cmp-nvim-lua", "cmp-path", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lsp_signature.nvim", "fidget.nvim", "diaglist.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "neogen", "nvim-gps", "refactoring.nvim", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-frecency.nvim", "git-worktree.nvim", "octo.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
try_loadstring("\27LJ\2\ne\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\3\24NeogitCommitMessage\1\18DressingInput\1\14gitcommit\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-surround', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
