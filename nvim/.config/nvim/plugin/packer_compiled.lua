...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-lua", "LuaSnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-emoji", "cmp-path", "cmp_luasnip", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lualine-lsp-progress", "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "session-lens", "workspaces.nvim", "octo.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
