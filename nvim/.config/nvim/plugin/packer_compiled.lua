...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lua", "cmp-emoji", "cmp-path", "LuaSnip", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "lspkind-nvim", "fidget.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-gps", "neogen", "playground", "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "octo.nvim", "git-worktree.nvim", "telescope-repo.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-dap.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-nonicons', 'vim-sleuth', 'gitsigns.nvim', 'FastFold', 'indent-blankline.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
