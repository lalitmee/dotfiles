...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-emoji", "cmp-tabnine", "cmp_luasnip", "cmp-path", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "lsp_signature.nvim", "diaglist.nvim", "fidget.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-sleuth', 'indent-blankline.nvim', 'FastFold', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
