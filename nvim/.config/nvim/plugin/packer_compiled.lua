...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "LuaSnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-emoji", "cmp_luasnip" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "workspaces.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "octo.nvim", "git-worktree.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
