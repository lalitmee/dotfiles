...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lua", "cmp-emoji", "LuaSnip", "cmp_luasnip", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "neogen", "playground", "nvim-gps" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-repo.nvim", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "octo.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua', 'vim-surround', 'vim-sleuth', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
