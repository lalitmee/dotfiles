...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-emoji", "cmp-nvim-lsp", "cmp-buffer", "cmp-tabnine", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "workspaces.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "octo.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-tmux.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-sleuth', 'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
