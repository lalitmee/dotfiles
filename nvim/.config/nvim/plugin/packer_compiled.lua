...
local no_errors, error_msg = pcall(function()
  ...
  _G.packer_plugins = {
    ...
    ["nordark.nvim"] = {
      loaded = true,
      path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/nordark.nvim"
    },
    ["nui.nvim"] = {
      loaded = true,
    ...
    spaceduck = {
      loaded = true,
      path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/spaceduck"
    },
    ["spaceless.nvim"] = {
    ...
    ["vim-better-whitespace"] = {
      config = {"\27LJ\2\nd\0\0\2\0\4\0\t6\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0)\1\1\0=\1\3\0K\0\1\0\29strip_whitespace_on_save\30better_whitespace_enabled\6g\bvim\0"},
      loaded = true,
  ...
  pcall(vim.cmd,
    [[command -nargs=* -range -bang -complete=file TrainUpDown lua require("packer.load")({'train.nvim'}, { cmd = "TrainUpDown", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
  pcall(vim.cmd,
  ...
  pcall(vim.cmd,
    [[command -nargs=* -range -bang -complete=file TrainTextObj lua require("packer.load")({'train.nvim'}, { cmd = "TrainTextObj", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
  pcall(vim.cmd,
  ...
  pcall(vim.cmd,
    [[command -nargs=* -range -bang -complete=file TrainWord lua require("packer.load")({'train.nvim'}, { cmd = "TrainWord", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
  pcall(vim.cmd,
