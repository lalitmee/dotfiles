...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-lsp", "LuaSnip", "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-emoji", "cmp_luasnip", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-gps", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neorg", "refactoring.nvim", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-fzf-native.nvim", "session-lens", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-repo.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-fold-cycle"] = {
    config = { "require('lk/plugins/vim-fold-cycle')" },
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/vim-fold-cycle",
...
-- Config for: vim-fold-cycle
time([[Config for vim-fold-cycle]], true)
require('lk/plugins/vim-fold-cycle')
time([[Config for vim-fold-cycle]], false)
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-sleuth', 'FastFold', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
