...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp_luasnip", "cmp-emoji", "LuaSnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "neogen", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "refactoring.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "session-lens", "telescope-frecency.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-devdocs"] = {
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/vim-devdocs",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'vim-sleuth', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
