...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\ne\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\3\14gitcommit\1\18DressingInput\1\24NeogitCommitMessage\1\22copilot_filetypes\6g\bvim\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "LuaSnip", "cmp-tabnine", "cmp-path", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-emoji", "cmp-buffer", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lua-dev.nvim", "lsp_signature.nvim", "lspkind-nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim", "nvim-gps", "neogen", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "octo.nvim", "telescope-repo.nvim" },
    commands = { "Telescope" },
...
try_loadstring("\27LJ\2\ne\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\3\14gitcommit\1\18DressingInput\1\24NeogitCommitMessage\1\22copilot_filetypes\6g\bvim\0", "config", "copilot.vim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-surround', 'vim-sleuth', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-bufferline.lua', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
