...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-tabnine", "cmp_luasnip", "cmp-path", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-gps", "refactoring.nvim", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "session-lens", "telescope-smart-history.nvim", "octo.nvim", "telescope-media-files.nvim", "refactoring.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'vim-surround', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-sleuth', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
