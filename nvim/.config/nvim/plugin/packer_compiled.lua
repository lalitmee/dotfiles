...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-cmdline", "cmp-emoji", "LuaSnip", "cmp-nvim-lua", "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "neogen" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "workspaces.nvim", "session-lens", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-sleuth', 'nvim-bufferline.lua', 'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
