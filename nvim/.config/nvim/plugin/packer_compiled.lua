...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "cmp-tabnine", "cmp-path", "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "fidget.nvim", "lsp_signature.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "neogen", "nvim-treesitter-textobjects", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-hop.nvim", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-media-files.nvim", "octo.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua', 'vim-surround', 'vim-sleuth', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
