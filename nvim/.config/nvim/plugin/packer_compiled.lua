...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "cmp-cmdline", "cmp-emoji", "cmp_luasnip", "LuaSnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim", "lspkind-nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "session-lens", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "octo.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "telescope-tmux.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'vim-sleuth', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
