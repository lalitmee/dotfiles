...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-path", "cmp-buffer", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-emoji" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-surround', 'vim-sleuth', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
