...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp-emoji", "cmp-buffer", "cmp-nvim-lsp", "cmp-tabnine", "LuaSnip", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neogen", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
