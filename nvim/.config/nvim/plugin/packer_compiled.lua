...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-path", "cmp-cmdline", "cmp_luasnip", "cmp-nvim-lua", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "lspkind-nvim", "diaglist.nvim", "lua-dev.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "playground", "nvim-treesitter-textobjects", "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-gps" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "session-lens", "refactoring.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-sleuth', 'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
