...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp_luasnip", "cmp-emoji", "LuaSnip", "cmp-path", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-tabnine", "cmp-buffer" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-tmux.nvim", "telescope-frecency.nvim", "refactoring.nvim", "octo.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "session-lens", "telescope-fzf-native.nvim", "git-worktree.nvim", "workspaces.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'FastFold', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
