...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-emoji", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-nonicons', 'indent-blankline.nvim', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
