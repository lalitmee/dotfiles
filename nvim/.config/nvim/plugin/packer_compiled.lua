...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp_luasnip", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-tmux.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "session-lens", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "octo.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
