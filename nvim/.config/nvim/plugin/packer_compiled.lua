...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-tabnine", "cmp-cmdline", "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-emoji", "cmp-nvim-lua" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "octo.nvim", "session-lens", "telescope-fzf-native.nvim", "refactoring.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'vim-sleuth', 'FastFold', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
