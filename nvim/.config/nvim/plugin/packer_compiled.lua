...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp_luasnip", "cmp-emoji" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "neogen", "nvim-treesitter-textobjects", "nvim-gps", "playground", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "refactoring.nvim", "git-worktree.nvim", "octo.nvim", "telescope-dap.nvim", "session-lens", "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'FastFold', 'vim-surround', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
