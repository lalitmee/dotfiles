...
_G.packer_plugins = {
  ...
  ["fold-cycle.nvim"] = {
    commands = { "FoldOpen", "FoldClose", "FoldToggleAll", "FoldOpenAll", "FoldCloseAll" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lsp", "cmp-nvim-lua", "LuaSnip", "cmp-path", "cmp-emoji", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "fidget.nvim", "diaglist.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-gps", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "neorg", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "telescope-dap.nvim", "octo.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "refactoring.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "session-lens", "telescope-file-browser.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'vim-sleuth', 'indent-blankline.nvim', 'gitsigns.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
