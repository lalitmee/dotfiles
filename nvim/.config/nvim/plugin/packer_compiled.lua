...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "LuaSnip", "cmp-emoji", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim", "lspkind-nvim", "fidget.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "refactoring.nvim", "playground", "nvim-gps", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-repo.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "refactoring.nvim", "git-worktree.nvim", "octo.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-sleuth', 'FastFold', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
