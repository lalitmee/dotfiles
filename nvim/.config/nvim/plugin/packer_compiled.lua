...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-emoji", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "LuaSnip", "cmp_luasnip", "cmp-tabnine", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "lspkind-nvim", "diaglist.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "refactoring.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "playground", "nvim-gps" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-repo.nvim", "git-worktree.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim", "octo.nvim", "telescope-frecency.nvim", "session-lens", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'vim-surround', 'FastFold', 'vim-sleuth', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
