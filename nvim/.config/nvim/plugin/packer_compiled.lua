...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-emoji", "LuaSnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-cmdline", "cmp-buffer", "cmp-tabnine" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "session-lens", "octo.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
