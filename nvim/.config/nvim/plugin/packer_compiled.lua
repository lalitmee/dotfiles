...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lua", "cmp-emoji", "cmp-path", "LuaSnip", "cmp-nvim-lsp", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lspkind-nvim", "fidget.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-gps", "playground", "neogen", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "octo.nvim", "git-worktree.nvim", "telescope-repo.nvim", "telescope-emoji.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
