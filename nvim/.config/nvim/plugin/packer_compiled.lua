...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-tabnine", "cmp-emoji", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lspkind-nvim", "fidget.nvim", "lsp_signature.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-ts-context-commentstring", "playground", "refactoring.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "octo.nvim", "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-frecency.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-nonicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
