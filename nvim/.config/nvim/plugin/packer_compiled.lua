...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp-tabnine", "cmp_luasnip", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "fidget.nvim", "lua-dev.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-gps", "neogen", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
  ...
  ["telescope-repo.nvim"] = {
    ...
    loaded = true,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/start/telescope-repo.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "git-worktree.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
