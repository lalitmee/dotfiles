...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-lua", "cmp-path", "LuaSnip", "cmp-nvim-lsp", "cmp-buffer", "cmp_luasnip", "cmp-cmdline", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lua-dev.nvim", "diaglist.nvim", "lualine-lsp-progress", "lsp_signature.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "refactoring.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "workspaces.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
