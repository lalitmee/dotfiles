...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-emoji", "cmp-buffer", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "lsp_signature.nvim", "fidget.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-gps", "nvim-treesitter-textobjects", "playground", "neogen", "nvim-ts-context-commentstring" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-emoji.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-repo.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "refactoring.nvim", "git-worktree.nvim", "octo.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'FastFold', 'nvim-bufferline.lua', 'vim-sleuth', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
