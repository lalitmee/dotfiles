...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp_luasnip", "cmp-path", "cmp-nvim-lua", "cmp-cmdline", "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-emoji" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "session-lens", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "octo.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-sleuth', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
