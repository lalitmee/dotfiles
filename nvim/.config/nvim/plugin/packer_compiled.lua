...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "LuaSnip", "cmp-cmdline", "cmp-path", "cmp-emoji", "cmp-tabnine", "cmp-nvim-lsp", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "lspkind-nvim", "lua-dev.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-nonicons"] = {
  ...
  ["telescope.nvim"] = {
    after = { "workspaces.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "octo.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "telescope-frecency.nvim", "telescope-smart-history.nvim" },
    commands = { "Telescope" },
