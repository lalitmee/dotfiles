...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "LuaSnip", "cmp-path", "cmp-cmdline", "cmp-buffer", "cmp-emoji", "cmp-nvim-lsp", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim", "lspkind-nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring", "neogen", "nvim-gps", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-sleuth', 'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'FastFold', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
