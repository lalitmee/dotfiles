...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-nvim-lsp", "LuaSnip", "cmp-emoji", "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "lsp_signature.nvim", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-tmux.nvim", "workspaces.nvim", "telescope-file-browser.nvim", "session-lens", "telescope-smart-history.nvim", "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-emoji.nvim", "telescope-ui-select.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua', 'vim-surround', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
