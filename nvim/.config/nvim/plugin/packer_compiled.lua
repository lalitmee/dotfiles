...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-tabnine", "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-emoji", "cmp-path", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lualine-lsp-progress", "lua-dev.nvim", "diaglist.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "telescope-media-files.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "octo.nvim", "refactoring.nvim", "telescope-frecency.nvim", "workspaces.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'FastFold', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
