...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "LuaSnip", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-emoji", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspkind-nvim", "diaglist.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-frecency.nvim", "telescope-tmux.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'vim-sleuth', 'nvim-nonicons', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
