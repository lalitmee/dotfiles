...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-nvim-lua", "cmp-tabnine", "cmp-nvim-lsp", "cmp-cmdline", "cmp-emoji", "cmp-path" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-ui", "nvim-dap-virtual-text", "telescope-dap.nvim" },
  ...
  ["nvim-lspconfig"] = {
    after = { "diaglist.nvim", "lsp_signature.nvim", "fidget.nvim", "lua-dev.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-treesitter-textobjects", "nvim-gps", "playground", "nvim-ts-context-commentstring", "refactoring.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-emoji.nvim", "octo.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "git-worktree.nvim", "telescope-repo.nvim", "telescope-frecency.nvim", "telescope-dap.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-nonicons', 'indent-blankline.nvim', 'vim-surround', 'nvim-bufferline.lua', 'vim-sleuth', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
