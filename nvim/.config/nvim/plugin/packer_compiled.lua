...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lua-dev.nvim", "lsp_signature.nvim", "lspkind-nvim", "diaglist.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "neogen" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-tmux.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-media-files.nvim", "telescope-hop.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "octo.nvim", "telescope-file-browser.nvim", "session-lens" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'gitsigns.nvim', 'FastFold', 'nvim-nonicons', 'vim-surround', 'vim-sleuth', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
