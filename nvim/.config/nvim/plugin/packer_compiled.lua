...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine", "cmp-nvim-lsp", "cmp-emoji", "LuaSnip", "cmp_luasnip", "cmp-buffer", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lsp_signature.nvim", "diaglist.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "workspaces.nvim", "telescope-frecency.nvim", "octo.nvim", "session-lens", "telescope-emoji.nvim", "telescope-ui-select.nvim", "telescope-tmux.nvim", "refactoring.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'vim-surround', 'nvim-bufferline.lua', 'vim-sleuth', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
