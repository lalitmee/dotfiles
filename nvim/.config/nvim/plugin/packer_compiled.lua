...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-tmux.nvim", "telescope-ui-select.nvim", "session-lens", "octo.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-media-files.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'vim-surround', 'nvim-nonicons', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-sleuth'}, { event = "BufRead *" }, _G.packer_plugins)]]
