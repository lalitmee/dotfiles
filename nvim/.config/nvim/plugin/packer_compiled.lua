...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp-emoji", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "lsp_signature.nvim", "lua-dev.nvim", "diaglist.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-ui-select.nvim", "workspaces.nvim", "session-lens", "telescope-fzf-native.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "telescope-emoji.nvim", "octo.nvim", "git-worktree.nvim", "refactoring.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bufferline.lua', 'FastFold', 'indent-blankline.nvim', 'nvim-nonicons', 'gitsigns.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
