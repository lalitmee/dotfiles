...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-emoji", "cmp-tabnine", "cmp-nvim-lua", "cmp-buffer", "cmp_luasnip", "LuaSnip", "cmp-nvim-lsp" },
  ...
  ["nvim-gps"] = {
    config = { "require('lk/plugins/gps')" },
    load_after = {
      ["nvim-treesitter"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/lalitmee/.local/share/nvim/site/pack/packer/opt/nvim-gps",
  ...
  ["nvim-treesitter"] = {
    after = { "refactoring.nvim", "nvim-gps", "nvim-ts-context-commentstring", "playground", "neogen", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "octo.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-media-files.nvim", "telescope-dap.nvim", "telescope-emoji.nvim", "refactoring.nvim", "telescope-file-browser.nvim", "git-worktree.nvim", "telescope-ui-select.nvim", "telescope-frecency.nvim", "telescope-repo.nvim", "session-lens", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-sleuth', 'FastFold', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
