...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-nvim-lsp", "cmp-tabnine", "LuaSnip", "cmp-cmdline", "cmp-emoji", "cmp-nvim-lua", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-virtual-text", "telescope-dap.nvim", "nvim-dap-ui" },
  ...
  ["nvim-treesitter"] = {
    after = { "neogen", "nvim-gps", "playground", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "refactoring.nvim" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-hop.nvim", "telescope-fzf-native.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "telescope-frecency.nvim", "telescope-emoji.nvim", "telescope-dap.nvim", "refactoring.nvim", "octo.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'vim-sleuth', 'FastFold', 'nvim-nonicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
