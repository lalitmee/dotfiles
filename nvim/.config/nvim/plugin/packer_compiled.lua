...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "LuaSnip", "cmp_luasnip", "cmp-nvim-lua", "cmp-cmdline", "cmp-emoji", "cmp-tabnine", "cmp-path", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lspkind-nvim", "diaglist.nvim", "fidget.nvim", "lua-dev.nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-tmux.nvim", "telescope-hop.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-media-files.nvim", "telescope-emoji.nvim", "octo.nvim", "telescope-ui-select.nvim", "session-lens", "telescope-frecency.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "git-worktree.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-nonicons', 'FastFold', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'vim-sleuth', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
