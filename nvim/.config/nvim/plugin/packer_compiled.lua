...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "LuaSnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "diaglist.nvim", "lspkind-nvim", "lsp_signature.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-emoji.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-tmux.nvim", "telescope-frecency.nvim", "octo.nvim", "telescope-smart-history.nvim", "git-worktree.nvim", "telescope-media-files.nvim", "telescope-file-browser.nvim", "refactoring.nvim", "telescope-ui-select.nvim", "session-lens", "workspaces.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'gitsigns.nvim', 'nvim-bufferline.lua', 'nvim-nonicons', 'indent-blankline.nvim', 'FastFold'}, { event = "BufRead *" }, _G.packer_plugins)]]
