...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "LuaSnip", "cmp-nvim-lua", "cmp-emoji" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-media-files.nvim", "session-lens", "telescope-tmux.nvim", "git-worktree.nvim", "octo.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "workspaces.nvim" },
    commands = { "Telescope" },
