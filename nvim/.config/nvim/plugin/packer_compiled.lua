...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-cmdline", "cmp-path", "cmp-tabnine", "cmp-emoji", "cmp-buffer", "cmp_luasnip", "LuaSnip", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "diaglist.nvim", "lspkind-nvim", "lua-dev.nvim", "fidget.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-hop.nvim", "session-lens", "telescope-file-browser.nvim", "telescope-emoji.nvim", "telescope-frecency.nvim", "octo.nvim", "refactoring.nvim", "git-worktree.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-bufferline.lua', 'nvim-nonicons', 'vim-surround', 'vim-sleuth', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
