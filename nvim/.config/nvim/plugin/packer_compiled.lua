...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-emoji", "cmp-path", "cmp-tabnine", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-gps", "playground", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "refactoring.nvim", "neogen" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "session-lens", "octo.nvim", "telescope-media-files.nvim", "git-worktree.nvim", "refactoring.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-emoji.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FastFold', 'nvim-nonicons', 'vim-sleuth', 'indent-blankline.nvim', 'vim-surround', 'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
